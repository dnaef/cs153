...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
    ...
    1011:	74 25                	je     1038 <main+0x38>
    printf(2, "Usage: ln old new\n");
    1013:	c7 44 24 04 76 17 00 	movl   $0x1776,0x4(%esp)
    101a:	00 
    101b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1022:	e8 e9 03 00 00       	call   1410 <printf>
    exit(0);
    1027:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    102e:	e8 85 02 00 00       	call   12b8 <exit>
    1033:	90                   	nop
    1034:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  }
  if(link(argv[1], argv[2]) < 0)
    1038:	8b 43 08             	mov    0x8(%ebx),%eax
    103b:	89 44 24 04          	mov    %eax,0x4(%esp)
    103f:	8b 43 04             	mov    0x4(%ebx),%eax
    1042:	89 04 24             	mov    %eax,(%esp)
    1045:	e8 ce 02 00 00       	call   1318 <link>
    104a:	85 c0                	test   %eax,%eax
    104c:	78 12                	js     1060 <main+0x60>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0);
    104e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    1055:	e8 5e 02 00 00       	call   12b8 <exit>
  ...
  if(link(argv[1], argv[2]) < 0)
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
    1060:	8b 43 08             	mov    0x8(%ebx),%eax
    1063:	89 44 24 0c          	mov    %eax,0xc(%esp)
    1067:	8b 43 04             	mov    0x4(%ebx),%eax
    106a:	c7 44 24 04 89 17 00 	movl   $0x1789,0x4(%esp)
    1071:	00 
    1072:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1079:	89 44 24 08          	mov    %eax,0x8(%esp)
    107d:	e8 8e 03 00 00       	call   1410 <printf>
    1082:	eb ca                	jmp    104e <main+0x4e>
    1084:	90                   	nop
    1085:	90                   	nop
    1086:	90                   	nop
    1087:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13aa:	f7 f7                	div    %edi
    13ac:	0f b6 92 a4 17 00 00 	movzbl 0x17a4(%edx),%edx
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    1540:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
    1543:	b9 9d 17 00 00       	mov    $0x179d,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1601:	a1 c0 17 00 00       	mov    0x17c0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    1651:	a3 c0 17 00 00       	mov    %eax,0x17c0
}
    1656:	5b                   	pop    %ebx
    1657:	5e                   	pop    %esi
    1658:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    167d:	a3 c0 17 00 00       	mov    %eax,0x17c0
}
    1682:	5b                   	pop    %ebx
    1683:	5e                   	pop    %esi
    1684:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    169c:	8b 0d c0 17 00 00    	mov    0x17c0,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    ...
    if(p == freep)
    16d0:	3b 05 c0 17 00 00    	cmp    0x17c0,%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16ef:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
    16f2:	89 0d c0 17 00 00    	mov    %ecx,0x17c0
      return (void*)(p + 1);
...
morecore(uint nu)
{
  ...
  return freep;
    1737:	8b 0d c0 17 00 00    	mov    0x17c0,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    174e:	c7 05 c0 17 00 00 b8 	movl   $0x17b8,0x17c0
    1755:	17 00 00 
    base.s.size = 0;
    1758:	b9 b8 17 00 00       	mov    $0x17b8,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    175d:	c7 05 b8 17 00 00 b8 	movl   $0x17b8,0x17b8
    1764:	17 00 00 
    base.s.size = 0;
    1767:	c7 05 bc 17 00 00 00 	movl   $0x0,0x17bc
    176e:	00 00 00 
