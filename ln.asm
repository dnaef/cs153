...
main(int argc, char *argv[])
{
  ...
  6a:	c7 44 24 04 69 07 00 	movl   $0x769,0x4(%esp)
  71:	00 
  72:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  79:	89 44 24 08          	mov    %eax,0x8(%esp)
  7d:	e8 6e 03 00 00       	call   3f0 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38a:	f7 f7                	div    %edi
 38c:	0f b6 92 84 07 00 00 	movzbl 0x784(%edx),%edx
...
putc(int fd, char c)
{
 ...
 520:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 523:	b9 7d 07 00 00       	mov    $0x77d,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 5e1:	a1 a0 07 00 00       	mov    0x7a0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 62f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 631:	a3 a0 07 00 00       	mov    %eax,0x7a0
}
 636:	5b                   	pop    %ebx
 637:	5e                   	pop    %esi
 638:	5f                   	pop    %edi
 ...
 65b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 a0 07 00 00       	mov    %eax,0x7a0
}
 662:	5b                   	pop    %ebx
 663:	5e                   	pop    %esi
 664:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 679:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 67c:	8b 0d a0 07 00 00    	mov    0x7a0,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6b0:	3b 05 a0 07 00 00    	cmp    0x7a0,%eax
 ...
 6cf:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6d2:	89 0d a0 07 00 00    	mov    %ecx,0x7a0
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 712:	e8 c9 fe ff ff       	call   5e0 <free>
  return freep;
 717:	8b 0d a0 07 00 00    	mov    0x7a0,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 72c:	eb a4                	jmp    6d2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 72e:	c7 05 a0 07 00 00 98 	movl   $0x798,0x7a0
 735:	07 00 00 
    base.s.size = 0;
 738:	b9 98 07 00 00       	mov    $0x798,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 73d:	c7 05 98 07 00 00 98 	movl   $0x798,0x798
 744:	07 00 00 
    base.s.size = 0;
 747:	c7 05 9c 07 00 00 00 	movl   $0x0,0x79c
 74e:	00 00 00 
