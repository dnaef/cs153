...
main(int argc, char *argv[])
{
  ...
  28:	c7 44 24 0c 56 07 00 	movl   $0x756,0xc(%esp)
  2f:	00 
  30:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  34:	83 c3 01             	add    $0x1,%ebx
  37:	c7 44 24 04 58 07 00 	movl   $0x758,0x4(%esp)
  3e:	00 
  ...
  53:	c7 44 24 0c 5d 07 00 	movl   $0x75d,0xc(%esp)
  5a:	00 
  5b:	8b 44 b7 fc          	mov    -0x4(%edi,%esi,4),%eax
  5f:	c7 44 24 04 58 07 00 	movl   $0x758,0x4(%esp)
  66:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38a:	f7 f7                	div    %edi
 38c:	0f b6 92 66 07 00 00 	movzbl 0x766(%edx),%edx
...
putc(int fd, char c)
{
 ...
 520:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 523:	b9 5f 07 00 00       	mov    $0x75f,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 5e1:	a1 80 07 00 00       	mov    0x780,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 62f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 631:	a3 80 07 00 00       	mov    %eax,0x780
}
 636:	5b                   	pop    %ebx
 637:	5e                   	pop    %esi
 638:	5f                   	pop    %edi
 ...
 65b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 80 07 00 00       	mov    %eax,0x780
}
 662:	5b                   	pop    %ebx
 663:	5e                   	pop    %esi
 664:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 679:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 67c:	8b 0d 80 07 00 00    	mov    0x780,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6b0:	3b 05 80 07 00 00    	cmp    0x780,%eax
 ...
 6cf:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6d2:	89 0d 80 07 00 00    	mov    %ecx,0x780
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 712:	e8 c9 fe ff ff       	call   5e0 <free>
  return freep;
 717:	8b 0d 80 07 00 00    	mov    0x780,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 72c:	eb a4                	jmp    6d2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 72e:	c7 05 80 07 00 00 78 	movl   $0x778,0x780
 735:	07 00 00 
    base.s.size = 0;
 738:	b9 78 07 00 00       	mov    $0x778,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 73d:	c7 05 78 07 00 00 78 	movl   $0x778,0x778
 744:	07 00 00 
    base.s.size = 0;
 747:	c7 05 7c 07 00 00 00 	movl   $0x0,0x77c
 74e:	00 00 00 
