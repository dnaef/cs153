...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++)
    ...
    1015:	7e 60                	jle    1077 <main+0x77>
    1017:	bb 01 00 00 00       	mov    $0x1,%ebx
    printf(1, "%s%s", argv[i], i+1 < argc ? " " : "\n");
    101c:	83 c3 01             	add    $0x1,%ebx
    101f:	39 de                	cmp    %ebx,%esi
    1021:	7e 30                	jle    1053 <main+0x53>
    1023:	90                   	nop
    1024:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    1028:	c7 44 24 0c 76 17 00 	movl   $0x1776,0xc(%esp)
    102f:	00 
    1030:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
    1034:	83 c3 01             	add    $0x1,%ebx
    1037:	c7 44 24 04 78 17 00 	movl   $0x1778,0x4(%esp)
    103e:	00 
    103f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1046:	89 44 24 08          	mov    %eax,0x8(%esp)
    104a:	e8 c1 03 00 00       	call   1410 <printf>
    104f:	39 de                	cmp    %ebx,%esi
    1051:	7f d5                	jg     1028 <main+0x28>
    1053:	c7 44 24 0c 7d 17 00 	movl   $0x177d,0xc(%esp)
    105a:	00 
    105b:	8b 44 b7 fc          	mov    -0x4(%edi,%esi,4),%eax
    105f:	c7 44 24 04 78 17 00 	movl   $0x1778,0x4(%esp)
    1066:	00 
    1067:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    106e:	89 44 24 08          	mov    %eax,0x8(%esp)
    1072:	e8 99 03 00 00       	call   1410 <printf>
  exit(0);
    1077:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    107e:	e8 35 02 00 00       	call   12b8 <exit>
    1083:	90                   	nop
    1084:	90                   	nop
    1085:	90                   	nop
    1086:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13aa:	f7 f7                	div    %edi
    13ac:	0f b6 92 86 17 00 00 	movzbl 0x1786(%edx),%edx
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    1540:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
    1543:	b9 7f 17 00 00       	mov    $0x177f,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1601:	a1 a0 17 00 00       	mov    0x17a0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    1651:	a3 a0 17 00 00       	mov    %eax,0x17a0
}
    1656:	5b                   	pop    %ebx
    1657:	5e                   	pop    %esi
    1658:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    167d:	a3 a0 17 00 00       	mov    %eax,0x17a0
}
    1682:	5b                   	pop    %ebx
    1683:	5e                   	pop    %esi
    1684:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    169c:	8b 0d a0 17 00 00    	mov    0x17a0,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    ...
    if(p == freep)
    16d0:	3b 05 a0 17 00 00    	cmp    0x17a0,%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16ef:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
    16f2:	89 0d a0 17 00 00    	mov    %ecx,0x17a0
      return (void*)(p + 1);
...
morecore(uint nu)
{
  ...
  return freep;
    1737:	8b 0d a0 17 00 00    	mov    0x17a0,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    174e:	c7 05 a0 17 00 00 98 	movl   $0x1798,0x17a0
    1755:	17 00 00 
    base.s.size = 0;
    1758:	b9 98 17 00 00       	mov    $0x1798,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    175d:	c7 05 98 17 00 00 98 	movl   $0x1798,0x1798
    1764:	17 00 00 
    base.s.size = 0;
    1767:	c7 05 9c 17 00 00 00 	movl   $0x0,0x179c
    176e:	00 00 00 
