...
801001c8:	c7 04 24 4e 6f 10 80 	movl   $0x80106f4e,(%esp)
...
801003f1:	c7 04 24 75 6f 10 80 	movl   $0x80106f75,(%esp)
...
80100407:	e8 64 04 00 00       	call   80100870 <cprintf>
  cprintf("\n");
8010040c:	c7 04 24 56 74 10 80 	movl   $0x80107456,(%esp)
...
8010042b:	83 c3 01             	add    $0x1,%ebx
    cprintf(" %p", pcs[i]);
8010042e:	c7 04 24 91 6f 10 80 	movl   $0x80106f91,(%esp)
...
80100475:	e8 06 56 00 00       	call   80105a80 <uartputc>
}
...
80100525:	e8 56 55 00 00       	call   80105a80 <uartputc>
8010052a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100531:	e8 4a 55 00 00       	call   80105a80 <uartputc>
80100536:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010053d:	e8 3e 55 00 00       	call   80105a80 <uartputc>
...
8010058a:	e9 5b ff ff ff       	jmp    801004ea <consputc+0x9a>
  ...
  if(pos < 0 || pos > 25*80)
    panic("pos under/overflow");
8010058f:	c7 04 24 95 6f 10 80 	movl   $0x80106f95,(%esp)
...
80100814:	0f b6 92 b8 6f 10 80 	movzbl -0x7fef9048(%edx),%edx
...
8010097a:	b8 b1 6f 10 80       	mov    $0x80106fb1,%eax
...
801009c4:	e9 be fe ff ff       	jmp    80100887 <cprintf+0x17>
  ...
  if (fmt == 0)
    panic("null fmt");
801009c9:	c7 04 24 a8 6f 10 80 	movl   $0x80106fa8,(%esp)
...
80100a3d:	0f 85 ed 01 00 00    	jne    80100c30 <exec+0x250>
  ...
  if((pgdir = setupkvm()) == 0)
80100a43:	e8 a8 5d 00 00       	call   801067f0 <setupkvm>
...
80100ad4:	e8 67 60 00 00       	call   80106b40 <allocuvm>
...
80100b0c:	e8 4f 61 00 00       	call   80106c60 <loaduvm>
...
80100b7e:	e8 bd 5f 00 00       	call   80106b40 <allocuvm>
...
80100ba3:	e8 e8 5c 00 00       	call   80106890 <clearpteu>
  sp = sz;
...
80100c1e:	e8 ad 5a 00 00       	call   801066d0 <copyout>
...
80100c94:	e8 37 5a 00 00       	call   801066d0 <copyout>
...
80100d21:	e8 fa 5f 00 00       	call   80106d20 <switchuvm>
  freevm(oldpgdir);
80100d26:	89 34 24             	mov    %esi,(%esp)
80100d29:	e8 c2 5c 00 00       	call   801069f0 <freevm>
...
80100e5c:	e9 2f 26 00 00       	jmp    80103490 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
80100e61:	c7 04 24 c9 6f 10 80 	movl   $0x80106fc9,(%esp)
80100e68:	e8 63 f5 ff ff       	call   801003d0 <panic>
  ...
  panic("filewrite");
80100e6d:	c7 04 24 cf 6f 10 80 	movl   $0x80106fcf,(%esp)
...
80100f22:	e9 69 24 00 00       	jmp    80103390 <piperead>
  ...
  panic("fileread");
80100f27:	c7 04 24 d9 6f 10 80 	movl   $0x80106fd9,(%esp)
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100fc7:	c7 04 24 e2 6f 10 80 	movl   $0x80106fe2,(%esp)
...
8010112b:	eb b8                	jmp    801010e5 <fileclose+0x85>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
8010112d:	c7 04 24 ea 6f 10 80 	movl   $0x80106fea,(%esp)
...
80101143:	83 ec 18             	sub    $0x18,%esp
  initlock(&ftable.lock, "ftable");
80101146:	c7 44 24 04 f4 6f 10 	movl   $0x80106ff4,0x4(%esp)
8010114d:	80 
...
8010126c:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
8010126d:	c7 04 24 fb 6f 10 80 	movl   $0x80106ffb,(%esp)
...
80101415:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101416:	c7 04 24 0b 70 10 80 	movl   $0x8010700b,(%esp)
...
80101609:	c7 04 24 1e 70 10 80 	movl   $0x8010701e,(%esp)
...
80101735:	eb 8b                	jmp    801016c2 <bmap+0x42>
  ...
  panic("bmap: out of range");
80101737:	c7 04 24 34 70 10 80 	movl   $0x80107034,(%esp)
...
80101a16:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101a17:	c7 04 24 59 70 10 80 	movl   $0x80107059,(%esp)
80101a1e:	e8 ad e9 ff ff       	call   801003d0 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101a23:	c7 04 24 47 70 10 80 	movl   $0x80107047,(%esp)
...
80101af8:	eb a2                	jmp    80101a9c <dirlink+0x6c>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101afa:	c7 04 24 59 70 10 80 	movl   $0x80107059,(%esp)
...
80101bd4:	e9 e7 f5 ff ff       	jmp    801011c0 <iget>
  ...
  panic("ialloc: no inodes");
80101bd9:	c7 04 24 66 70 10 80 	movl   $0x80107066,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
80101c2a:	c7 04 24 78 70 10 80 	movl   $0x80107078,(%esp)
...
80101d11:	0f 85 78 ff ff ff    	jne    80101c8f <ilock+0x2f>
      panic("ilock: no type");
80101d17:	c7 04 24 86 70 10 80 	movl   $0x80107086,(%esp)
80101d1e:	e8 ad e6 ff ff       	call   801003d0 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
80101d23:	c7 04 24 80 70 10 80 	movl   $0x80107080,(%esp)
...
80101ee6:	83 ec 24             	sub    $0x24,%esp
  ...
  initlock(&icache.lock, "icache");
80101ee9:	c7 44 24 04 95 70 10 	movl   $0x80107095,0x4(%esp)
80101ef0:	80 
...
80101f0e:	c7 44 24 04 9c 70 10 	movl   $0x8010709c,0x4(%esp)
80101f15:	80 
...
80101f3b:	c7 04 24 a4 70 10 80 	movl   $0x801070a4,(%esp)
...
8010202f:	c7 04 24 00 71 10 80 	movl   $0x80107100,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
8010203b:	c7 04 24 f7 70 10 80 	movl   $0x801070f7,(%esp)
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
801020fc:	c7 04 24 12 71 10 80 	movl   $0x80107112,(%esp)
80102103:	e8 c8 e2 ff ff       	call   801003d0 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
80102108:	c7 04 24 3d 71 10 80 	movl   $0x8010713d,(%esp)
8010210f:	e8 bc e2 ff ff       	call   801003d0 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
80102114:	c7 04 24 28 71 10 80 	movl   $0x80107128,(%esp)
...
801021c6:	c7 44 24 04 5b 71 10 	movl   $0x8010715b,0x4(%esp)
801021cd:	80 
...
801022fb:	c7 04 24 60 71 10 80 	movl   $0x80107160,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
8010243e:	c7 04 24 92 71 10 80 	movl   $0x80107192,(%esp)
...
801024e2:	c7 44 24 04 98 71 10 	movl   $0x80107198,0x4(%esp)
801024e9:	80 
...
8010255e:	0f b6 80 a0 71 10 80 	movzbl -0x7fef8e60(%eax),%eax
...
80102588:	0f b6 90 a0 71 10 80 	movzbl -0x7fef8e60(%eax),%edx
8010258f:	09 ca                	or     %ecx,%edx
80102591:	0f b6 88 a0 72 10 80 	movzbl -0x7fef8d60(%eax),%ecx
80102598:	31 ca                	xor    %ecx,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010259a:	89 d1                	mov    %edx,%ecx
8010259c:	83 e1 03             	and    $0x3,%ecx
8010259f:	8b 0c 8d a0 73 10 80 	mov    -0x7fef8c60(,%ecx,4),%ecx
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
80102a8e:	c7 04 24 b0 73 10 80 	movl   $0x801073b0,(%esp)
...
80102aaf:	c3                   	ret    
  ...
  panic("unknown apicid\n");
80102ab0:	c7 04 24 dc 73 10 80 	movl   $0x801073dc,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102b52:	c7 04 24 ec 73 10 80 	movl   $0x801073ec,(%esp)
80102b59:	e8 72 d8 ff ff       	call   801003d0 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102b5e:	c7 04 24 02 74 10 80 	movl   $0x80107402,(%esp)
...
80102da1:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102da2:	c7 04 24 1d 74 10 80 	movl   $0x8010741d,(%esp)
...
80102e2b:	c7 44 24 04 2c 74 10 	movl   $0x8010742c,0x4(%esp)
80102e32:	80 
...
80102ecb:	c7 04 24 30 74 10 80 	movl   $0x80107430,(%esp)
80102ed2:	89 44 24 04          	mov    %eax,0x4(%esp)
80102ed6:	e8 95 d9 ff ff       	call   80100870 <cprintf>
  idtinit();       // load idt register
80102edb:	e8 20 28 00 00       	call   80105700 <idtinit>
...
80102f1e:	e8 4d 39 00 00       	call   80106870 <kvmalloc>
...
80102f30:	e8 cb 3e 00 00       	call   80106e00 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpunum());
80102f35:	e8 e6 fa ff ff       	call   80102a20 <cpunum>
80102f3a:	c7 04 24 41 74 10 80 	movl   $0x80107441,(%esp)
...
80102f59:	e8 72 2b 00 00       	call   80105ad0 <uartinit>
80102f5e:	66 90                	xchg   %ax,%ax
  pinit();         // process table
80102f60:	e8 cb 11 00 00       	call   80104130 <pinit>
  tvinit();        // trap vectors
80102f65:	e8 36 2a 00 00       	call   801059a0 <tvinit>
  binit();         // buffer cache
...
8010304c:	e8 6f fe ff ff       	call   80102ec0 <mpmain>
  ...
  if(!ismp)
    timerinit();   // uniprocessor timer
80103051:	e8 4a 26 00 00       	call   801056a0 <timerinit>
...
80103063:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103066:	e8 95 35 00 00       	call   80106600 <switchkvm>
  seginit();
8010306b:	e8 90 3d 00 00       	call   80106e00 <seginit>
  lapicinit();
...
8010309f:	00 
801030a0:	c7 44 24 04 58 74 10 	movl   $0x80107458,0x4(%esp)
801030a7:	80 
...
8010315e:	00 
8010315f:	c7 44 24 04 5d 74 10 	movl   $0x8010745d,0x4(%esp)
80103166:	80 
...
801031de:	ff 24 95 64 74 10 80 	jmp    *-0x7fef8b9c(,%edx,4)
...
8010368f:	c7 44 24 04 78 74 10 	movl   $0x80107478,0x4(%esp)
80103696:	80 
...
80103703:	83 ec 18             	sub    $0x18,%esp
	...
	cprintf("\nHello!!!!!!! \n");
80103706:	c7 04 24 7d 74 10 80 	movl   $0x8010747d,(%esp)
...
80103738:	8b 04 85 60 75 10 80 	mov    -0x7fef8aa0(,%eax,4),%eax
...
80103751:	c7 04 24 91 74 10 80 	movl   $0x80107491,(%esp)
...
80103765:	74 31                	je     80103798 <procdump+0x78>
    ...
    cprintf("\n");
80103767:	c7 04 24 56 74 10 80 	movl   $0x80107456,(%esp)
...
8010378a:	b8 8d 74 10 80       	mov    $0x8010748d,%eax
...
801037be:	c7 04 24 91 6f 10 80 	movl   $0x80106f91,(%esp)
...
sched(void)
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103994:	c7 04 24 9a 74 10 80 	movl   $0x8010749a,(%esp)
8010399b:	e8 30 ca ff ff       	call   801003d0 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
801039a0:	c7 04 24 c6 74 10 80 	movl   $0x801074c6,(%esp)
801039a7:	e8 24 ca ff ff       	call   801003d0 <panic>
  ...
  if(proc->state == RUNNING)
    panic("sched running");
801039ac:	c7 04 24 b8 74 10 80 	movl   $0x801074b8,(%esp)
801039b3:	e8 18 ca ff ff       	call   801003d0 <panic>
  ...
  if(cpu->ncli != 1)
    panic("sched locks");
801039b8:	c7 04 24 ac 74 10 80 	movl   $0x801074ac,(%esp)
...
80103a81:	c7 04 24 e0 74 10 80 	movl   $0x801074e0,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  if(proc == 0)
    panic("sleep");
80103a8d:	c7 04 24 da 74 10 80 	movl   $0x801074da,(%esp)
...
80103b1b:	e8 00 32 00 00       	call   80106d20 <switchuvm>
      p->state = RUNNING;
...
80103b3d:	e8 9a 0b 00 00       	call   801046dc <swtch>
      switchkvm();
80103b42:	e8 b9 2a 00 00       	call   80106600 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103c35:	e8 b6 2d 00 00       	call   801069f0 <freevm>
        p->pid = 0;
...
80103d91:	e8 9a fb ff ff       	call   80103930 <sched>
  panic("zombie exit");
80103d96:	c7 04 24 fe 74 10 80 	movl   $0x801074fe,(%esp)
80103d9d:	e8 2e c6 ff ff       	call   801003d0 <panic>
{
  ...
  if(proc == initproc)
    panic("init exiting");
80103da2:	c7 04 24 f1 74 10 80 	movl   $0x801074f1,(%esp)
...
80103e22:	c7 80 b0 0f 00 00 f0 	movl   $0x801056f0,0xfb0(%eax)
80103e29:	56 10 80 
...
80103ebf:	e8 ac 2b 00 00       	call   80106a70 <copyuvm>
...
80103fd4:	e8 47 2d 00 00       	call   80106d20 <switchuvm>
...
80103ff0:	e8 4b 2b 00 00       	call   80106b40 <allocuvm>
...
80104012:	e8 39 29 00 00       	call   80106950 <deallocuvm>
...
80104043:	e8 a8 27 00 00       	call   801067f0 <setupkvm>
...
80104065:	80 
80104066:	e8 55 28 00 00       	call   801068c0 <inituvm>
  p->sz = PGSIZE;
...
801040dc:	00 
801040dd:	c7 44 24 04 23 75 10 	movl   $0x80107523,0x4(%esp)
801040e4:	80 
801040e5:	89 04 24             	mov    %eax,(%esp)
801040e8:	e8 93 05 00 00       	call   80104680 <safestrcpy>
  p->cwd = namei("/");
801040ed:	c7 04 24 2c 75 10 80 	movl   $0x8010752c,(%esp)
...
80104120:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
80104121:	c7 04 24 0a 75 10 80 	movl   $0x8010750a,(%esp)
...
80104136:	c7 44 24 04 2e 75 10 	movl   $0x8010752e,0x4(%esp)
8010413d:	80 
...
8010422a:	c7 44 24 04 78 75 10 	movl   $0x80107578,0x4(%esp)
80104231:	80 
...
popcli(void)
{
  ...
  if(--cpu->ncli < 0)
    panic("popcli");
80104384:	c7 04 24 9a 75 10 80 	movl   $0x8010759a,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104390:	c7 04 24 83 75 10 80 	movl   $0x80107583,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
801043bb:	c7 04 24 a1 75 10 80 	movl   $0x801075a1,(%esp)
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
80104480:	c7 04 24 a9 75 10 80 	movl   $0x801075a9,(%esp)
...
801048f6:	c7 04 24 b1 75 10 80 	movl   $0x801075b1,(%esp)
...
801054c3:	83 ec 08             	sub    $0x8,%esp
  hello();
801054c6:	e8 35 e2 ff ff       	call   80103700 <hello>
  return 0;
}
...
80105515:	e8 86 f2 ff ff       	call   801047a0 <argint>
8010551a:	89 c2                	mov    %eax,%edx
8010551c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105521:	85 d2                	test   %edx,%edx
80105523:	78 59                	js     8010557e <sys_sleep+0x7e>
    return -1;
  acquire(&tickslock);
80105525:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
8010552c:	e8 bf ee ff ff       	call   801043f0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105531:	8b 55 f4             	mov    -0xc(%ebp),%edx
  uint ticks0;
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105534:	8b 1d 20 56 11 80    	mov    0x80115620,%ebx
  while(ticks - ticks0 < n){
8010553a:	85 d2                	test   %edx,%edx
8010553c:	75 22                	jne    80105560 <sys_sleep+0x60>
8010553e:	eb 48                	jmp    80105588 <sys_sleep+0x88>
    if(proc->killed){
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80105540:	c7 44 24 04 e0 4d 11 	movl   $0x80114de0,0x4(%esp)
80105547:	80 
80105548:	c7 04 24 20 56 11 80 	movl   $0x80115620,(%esp)
8010554f:	e8 7c e4 ff ff       	call   801039d0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105554:	a1 20 56 11 80       	mov    0x80115620,%eax
...
8010556b:	74 d3                	je     80105540 <sys_sleep+0x40>
      release(&tickslock);
8010556d:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
80105574:	e8 27 ee ff ff       	call   801043a0 <release>
...
80105584:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105588:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
8010558f:	e8 0c ee ff ff       	call   801043a0 <release>
  return 0;
}
...
801055b5:	e8 e6 f1 ff ff       	call   801047a0 <argint>
801055ba:	85 c0                	test   %eax,%eax
801055bc:	79 12                	jns    801055d0 <sys_sbrk+0x30>
    return -1;
  addr = proc->sz;
  if(growproc(n) < 0)
    return -1;
...
801055de:	e8 cd e9 ff ff       	call   80103fb0 <growproc>
...
801055e9:	79 d8                	jns    801055c3 <sys_sbrk+0x23>
801055eb:	eb d1                	jmp    801055be <sys_sbrk+0x1e>
...
80105634:	83 ec 24             	sub    $0x24,%esp
  int waitStatus;
  argint(0, &waitStatus);
80105637:	8d 5d f4             	lea    -0xc(%ebp),%ebx
8010563a:	89 5c 24 04          	mov    %ebx,0x4(%esp)
8010563e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105645:	e8 56 f1 ff ff       	call   801047a0 <argint>
  return wait(&waitStatus);
8010564a:	89 1c 24             	mov    %ebx,(%esp)
8010564d:	e8 2e e5 ff ff       	call   80103b80 <wait>
}
...
80105674:	e8 27 f1 ff ff       	call   801047a0 <argint>
  exit(exitstat);
80105679:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010567c:	89 04 24             	mov    %eax,(%esp)
8010567f:	e8 ec e5 ff ff       	call   80103c70 <exit>
  return 0;  // not reached
}
...
{
  return fork();
80105697:	e9 f4 e7 ff ff       	jmp    80103e90 <fork>
8010569c:	00 00                	add    %al,(%eax)
	...
...
801056ab:	b8 34 00 00 00       	mov    $0x34,%eax
...
801056c6:	e8 f5 db ff ff       	call   801032c0 <picenable>
}
801056cb:	c9                   	leave  
801056cc:	c3                   	ret    
801056cd:	00 00                	add    %al,(%eax)
	...
...
801056d1:	06                   	push   %es
  pushl %fs
801056d2:	0f a0                	push   %fs
  pushl %gs
801056d4:	0f a8                	push   %gs
  pushal
801056d6:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801056d7:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801056db:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801056dd:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801056df:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801056e3:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801056e5:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801056e7:	54                   	push   %esp
  call trap
801056e8:	e8 43 00 00 00       	call   80105730 <trap>
  addl $4, %esp
801056ed:	83 c4 04             	add    $0x4,%esp
...
801056f0:	61                   	popa   
  popl %gs
801056f1:	0f a9                	pop    %gs
  popl %fs
801056f3:	0f a1                	pop    %fs
  popl %es
801056f5:	07                   	pop    %es
  popl %ds
801056f6:	1f                   	pop    %ds
...
801056f7:	83 c4 08             	add    $0x8,%esp
  iret
801056fa:	cf                   	iret   
801056fb:	00 00                	add    %al,(%eax)
801056fd:	00 00                	add    %al,(%eax)
	...
...
lidt(struct gatedesc *p, int size)
{
  ...
  pd[0] = size-1;
  pd[1] = (uint)p;
80105701:	b8 20 4e 11 80       	mov    $0x80114e20,%eax
...
lidt(struct gatedesc *p, int size)
{
  ...
  pd[0] = size-1;
8010570b:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80105711:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105715:	c1 e8 10             	shr    $0x10,%eax
80105718:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
8010571c:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010571f:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105722:	c9                   	leave  
80105723:	c3                   	ret    
...
80105733:	83 ec 38             	sub    $0x38,%esp
80105736:	89 5d f4             	mov    %ebx,-0xc(%ebp)
80105739:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010573c:	89 75 f8             	mov    %esi,-0x8(%ebp)
8010573f:	89 7d fc             	mov    %edi,-0x4(%ebp)
  if(tf->trapno == T_SYSCALL){
80105742:	8b 43 30             	mov    0x30(%ebx),%eax
80105745:	83 f8 40             	cmp    $0x40,%eax
80105748:	0f 84 d2 00 00 00    	je     80105820 <trap+0xf0>
    if(proc->killed)
      exit(0);
    return;
  }
  ...
  switch(tf->trapno){
8010574e:	83 e8 20             	sub    $0x20,%eax
80105751:	83 f8 1f             	cmp    $0x1f,%eax
80105754:	0f 86 be 00 00 00    	jbe    80105818 <trap+0xe8>
    lapiceoi();
    break;
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
8010575a:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80105761:	85 c9                	test   %ecx,%ecx
80105763:	0f 84 fe 01 00 00    	je     80105967 <trap+0x237>
80105769:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010576d:	0f 84 f4 01 00 00    	je     80105967 <trap+0x237>
...
80105776:	8b 73 38             	mov    0x38(%ebx),%esi
80105779:	e8 a2 d2 ff ff       	call   80102a20 <cpunum>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
8010577e:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105785:	89 7c 24 1c          	mov    %edi,0x1c(%esp)
80105789:	89 74 24 18          	mov    %esi,0x18(%esp)
8010578d:	89 44 24 14          	mov    %eax,0x14(%esp)
80105791:	8b 43 34             	mov    0x34(%ebx),%eax
80105794:	89 44 24 10          	mov    %eax,0x10(%esp)
80105798:	8b 43 30             	mov    0x30(%ebx),%eax
8010579b:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010579f:	8d 42 6c             	lea    0x6c(%edx),%eax
801057a2:	89 44 24 08          	mov    %eax,0x8(%esp)
801057a6:	8b 42 10             	mov    0x10(%edx),%eax
801057a9:	c7 04 24 f8 76 10 80 	movl   $0x801076f8,(%esp)
801057b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801057b4:	e8 b7 b0 ff ff       	call   80100870 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
            rcr2());
    proc->killed = 1;
...
801057d0:	74 34                	je     80105806 <trap+0xd6>
801057d2:	8b 50 24             	mov    0x24(%eax),%edx
801057d5:	85 d2                	test   %edx,%edx
801057d7:	74 10                	je     801057e9 <trap+0xb9>
801057d9:	0f b7 53 3c          	movzwl 0x3c(%ebx),%edx
801057dd:	83 e2 03             	and    $0x3,%edx
801057e0:	83 fa 03             	cmp    $0x3,%edx
801057e3:	0f 84 5f 01 00 00    	je     80105948 <trap+0x218>
    exit(0);

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
801057e9:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801057ed:	0f 84 2d 01 00 00    	je     80105920 <trap+0x1f0>
    yield();

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801057f3:	8b 40 24             	mov    0x24(%eax),%eax
801057f6:	85 c0                	test   %eax,%eax
801057f8:	74 0c                	je     80105806 <trap+0xd6>
801057fa:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801057fe:	83 e0 03             	and    $0x3,%eax
80105801:	83 f8 03             	cmp    $0x3,%eax
80105804:	74 3c                	je     80105842 <trap+0x112>
    exit(0);
}
80105806:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80105809:	8b 75 f8             	mov    -0x8(%ebp),%esi
8010580c:	8b 7d fc             	mov    -0x4(%ebp),%edi
8010580f:	89 ec                	mov    %ebp,%esp
80105811:	5d                   	pop    %ebp
80105812:	c3                   	ret    
80105813:	90                   	nop
80105814:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  switch(tf->trapno){
80105818:	ff 24 85 48 77 10 80 	jmp    *-0x7fef88b8(,%eax,4)
8010581f:	90                   	nop
//PAGEBREAK: 41
void
trap(struct trapframe *tf)
...
80105826:	8b 70 24             	mov    0x24(%eax),%esi
80105829:	85 f6                	test   %esi,%esi
8010582b:	75 33                	jne    80105860 <trap+0x130>
      exit(0);
    proc->tf = tf;
8010582d:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105830:	e8 7b f0 ff ff       	call   801048b0 <syscall>
    if(proc->killed)
80105835:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010583b:	8b 58 24             	mov    0x24(%eax),%ebx
8010583e:	85 db                	test   %ebx,%ebx
80105840:	74 c4                	je     80105806 <trap+0xd6>
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
  ...
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
    exit(0);
80105842:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
}
...
80105854:	5d                   	pop    %ebp
  ...
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
    exit(0);
80105855:	e9 16 e4 ff ff       	jmp    80103c70 <exit>
...
80105867:	e8 04 e4 ff ff       	call   80103c70 <exit>
8010586c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105872:	eb b9                	jmp    8010582d <trap+0xfd>
80105874:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105878:	e8 a3 c8 ff ff       	call   80102120 <ideintr>
    lapiceoi();
8010587d:	e8 ce ce ff ff       	call   80102750 <lapiceoi>
    break;
80105882:	e9 41 ff ff ff       	jmp    801057c8 <trap+0x98>
80105887:	90                   	nop
    uartintr();
    lapiceoi();
    break;
...
80105888:	8b 7b 38             	mov    0x38(%ebx),%edi
8010588b:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
8010588f:	e8 8c d1 ff ff       	call   80102a20 <cpunum>
80105894:	c7 04 24 a0 76 10 80 	movl   $0x801076a0,(%esp)
8010589b:	89 7c 24 0c          	mov    %edi,0xc(%esp)
8010589f:	89 74 24 08          	mov    %esi,0x8(%esp)
801058a3:	89 44 24 04          	mov    %eax,0x4(%esp)
801058a7:	e8 c4 af ff ff       	call   80100870 <cprintf>
            cpunum(), tf->cs, tf->eip);
    lapiceoi();
801058ac:	e8 9f ce ff ff       	call   80102750 <lapiceoi>
    break;
801058b1:	e9 12 ff ff ff       	jmp    801057c8 <trap+0x98>
...
801058b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801058c0:	e8 9b 01 00 00       	call   80105a60 <uartintr>
    lapiceoi();
801058c5:	e8 86 ce ff ff       	call   80102750 <lapiceoi>
    break;
801058ca:	e9 f9 fe ff ff       	jmp    801057c8 <trap+0x98>
801058cf:	90                   	nop
    break;
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801058d0:	e8 1b cd ff ff       	call   801025f0 <kbdintr>
    lapiceoi();
801058d5:	e8 76 ce ff ff       	call   80102750 <lapiceoi>
    break;
801058da:	e9 e9 fe ff ff       	jmp    801057c8 <trap+0x98>
801058df:	90                   	nop
    return;
  }
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
801058e0:	e8 3b d1 ff ff       	call   80102a20 <cpunum>
801058e5:	85 c0                	test   %eax,%eax
801058e7:	75 94                	jne    8010587d <trap+0x14d>
      acquire(&tickslock);
801058e9:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
801058f0:	e8 fb ea ff ff       	call   801043f0 <acquire>
      ticks++;
801058f5:	83 05 20 56 11 80 01 	addl   $0x1,0x80115620
      wakeup(&ticks);
801058fc:	c7 04 24 20 56 11 80 	movl   $0x80115620,(%esp)
80105903:	e8 78 df ff ff       	call   80103880 <wakeup>
      release(&tickslock);
80105908:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
8010590f:	e8 8c ea ff ff       	call   801043a0 <release>
80105914:	e9 64 ff ff ff       	jmp    8010587d <trap+0x14d>
...
80105924:	0f 85 c9 fe ff ff    	jne    801057f3 <trap+0xc3>
8010592a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    yield();
80105930:	e8 6b e1 ff ff       	call   80103aa0 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80105935:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010593b:	85 c0                	test   %eax,%eax
8010593d:	0f 85 b0 fe ff ff    	jne    801057f3 <trap+0xc3>
80105943:	e9 be fe ff ff       	jmp    80105806 <trap+0xd6>
  ...
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
    exit(0);
80105948:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010594f:	e8 1c e3 ff ff       	call   80103c70 <exit>
...
8010595c:	0f 85 87 fe ff ff    	jne    801057e9 <trap+0xb9>
80105962:	e9 9f fe ff ff       	jmp    80105806 <trap+0xd6>
80105967:	0f 20 d7             	mov    %cr2,%edi
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010596a:	8b 73 38             	mov    0x38(%ebx),%esi
8010596d:	e8 ae d0 ff ff       	call   80102a20 <cpunum>
80105972:	89 7c 24 10          	mov    %edi,0x10(%esp)
80105976:	89 74 24 0c          	mov    %esi,0xc(%esp)
8010597a:	89 44 24 08          	mov    %eax,0x8(%esp)
8010597e:	8b 43 30             	mov    0x30(%ebx),%eax
80105981:	c7 04 24 c4 76 10 80 	movl   $0x801076c4,(%esp)
80105988:	89 44 24 04          	mov    %eax,0x4(%esp)
8010598c:	e8 df ae ff ff       	call   80100870 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
80105991:	c7 04 24 3b 77 10 80 	movl   $0x8010773b,(%esp)
80105998:	e8 33 aa ff ff       	call   801003d0 <panic>
...
801059a5:	ba 20 4e 11 80       	mov    $0x80114e20,%edx
...
801059b0:	8b 0c 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%ecx
801059b7:	66 89 0c c5 20 4e 11 	mov    %cx,-0x7feeb1e0(,%eax,8)
801059be:	80 
...
801059e2:	a1 0c a1 10 80       	mov    0x8010a10c,%eax

  initlock(&tickslock, "time");
801059e7:	c7 44 24 04 40 77 10 	movl   $0x80107740,0x4(%esp)
801059ee:	80 
801059ef:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059f6:	66 c7 05 22 50 11 80 	movw   $0x8,0x80115022
801059fd:	08 00 
801059ff:	66 a3 20 50 11 80    	mov    %ax,0x80115020
80105a05:	c1 e8 10             	shr    $0x10,%eax
80105a08:	c6 05 24 50 11 80 00 	movb   $0x0,0x80115024
80105a0f:	c6 05 25 50 11 80 ef 	movb   $0xef,0x80115025
80105a16:	66 a3 26 50 11 80    	mov    %ax,0x80115026

  initlock(&tickslock, "time");
80105a1c:	e8 3f e8 ff ff       	call   80104260 <initlock>
}
80105a21:	c9                   	leave  
80105a22:	c3                   	ret    
	...
...
{
  if(!uart)
80105a30:	a1 c8 a5 10 80       	mov    0x8010a5c8,%eax
  outb(COM1+0, c);
}
...
80105a6d:	e8 ce ab ff ff       	call   80100640 <consoleintr>
}
80105a72:	c9                   	leave  
80105a73:	c3                   	ret    
...
80105a8c:	83 ec 10             	sub    $0x10,%esp
  ...
  if(!uart)
80105a8f:	8b 15 c8 a5 10 80    	mov    0x8010a5c8,%edx
...
80105aaa:	e8 c1 cc ff ff       	call   80102770 <microdelay>
{
  int i;
...
80105b1e:	74 55                	je     80105b75 <uartinit+0xa5>
    return;
  uart = 1;
80105b20:	c7 05 c8 a5 10 80 01 	movl   $0x1,0x8010a5c8
80105b27:	00 00 00 
...
80105b30:	bb c8 77 10 80       	mov    $0x801077c8,%ebx
  ...
  inb(COM1+0);
  picenable(IRQ_COM1);
80105b35:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105b3c:	e8 7f d7 ff ff       	call   801032c0 <picenable>
  ioapicenable(IRQ_COM1, 0);
80105b41:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b48:	00 
80105b49:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105b50:	e8 fb c6 ff ff       	call   80102250 <ioapicenable>
...
80105b5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  for(p="xv6...\n"; *p; p++)
    uartputc(*p);
80105b60:	0f be c0             	movsbl %al,%eax
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80105b69:	e8 12 ff ff ff       	call   80105a80 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105b6e:	0f b6 03             	movzbl (%ebx),%eax
80105b71:	84 c0                	test   %al,%al
80105b73:	75 eb                	jne    80105b60 <uartinit+0x90>
    uartputc(*p);
}
80105b75:	83 c4 1c             	add    $0x1c,%esp
80105b78:	5b                   	pop    %ebx
80105b79:	5e                   	pop    %esi
80105b7a:	5f                   	pop    %edi
80105b7b:	5d                   	pop    %ebp
80105b7c:	c3                   	ret    
80105b7d:	00 00                	add    %al,(%eax)
	...
...
80105b82:	6a 00                	push   $0x0
  jmp alltraps
80105b84:	e9 47 fb ff ff       	jmp    801056d0 <alltraps>
...
80105b8b:	6a 01                	push   $0x1
  jmp alltraps
80105b8d:	e9 3e fb ff ff       	jmp    801056d0 <alltraps>
...
80105b94:	6a 02                	push   $0x2
  jmp alltraps
80105b96:	e9 35 fb ff ff       	jmp    801056d0 <alltraps>
...
80105b9b:	6a 00                	push   $0x0
  pushl $3
80105b9d:	6a 03                	push   $0x3
  jmp alltraps
80105b9f:	e9 2c fb ff ff       	jmp    801056d0 <alltraps>
...
80105ba6:	6a 04                	push   $0x4
  jmp alltraps
80105ba8:	e9 23 fb ff ff       	jmp    801056d0 <alltraps>
...
80105bad:	6a 00                	push   $0x0
  pushl $5
80105baf:	6a 05                	push   $0x5
  jmp alltraps
80105bb1:	e9 1a fb ff ff       	jmp    801056d0 <alltraps>
...
80105bb6:	6a 00                	push   $0x0
  pushl $6
80105bb8:	6a 06                	push   $0x6
  jmp alltraps
80105bba:	e9 11 fb ff ff       	jmp    801056d0 <alltraps>
...
80105bbf:	6a 00                	push   $0x0
  pushl $7
80105bc1:	6a 07                	push   $0x7
  jmp alltraps
80105bc3:	e9 08 fb ff ff       	jmp    801056d0 <alltraps>

80105bc8 <vector8>:
.globl vector8
vector8:
  pushl $8
80105bc8:	6a 08                	push   $0x8
  jmp alltraps
80105bca:	e9 01 fb ff ff       	jmp    801056d0 <alltraps>
...
80105bcf:	6a 00                	push   $0x0
  pushl $9
80105bd1:	6a 09                	push   $0x9
  jmp alltraps
80105bd3:	e9 f8 fa ff ff       	jmp    801056d0 <alltraps>

80105bd8 <vector10>:
.globl vector10
vector10:
  pushl $10
80105bd8:	6a 0a                	push   $0xa
  jmp alltraps
80105bda:	e9 f1 fa ff ff       	jmp    801056d0 <alltraps>

80105bdf <vector11>:
.globl vector11
vector11:
  pushl $11
80105bdf:	6a 0b                	push   $0xb
  jmp alltraps
80105be1:	e9 ea fa ff ff       	jmp    801056d0 <alltraps>

80105be6 <vector12>:
.globl vector12
vector12:
  pushl $12
80105be6:	6a 0c                	push   $0xc
  jmp alltraps
80105be8:	e9 e3 fa ff ff       	jmp    801056d0 <alltraps>

80105bed <vector13>:
.globl vector13
vector13:
  pushl $13
80105bed:	6a 0d                	push   $0xd
  jmp alltraps
80105bef:	e9 dc fa ff ff       	jmp    801056d0 <alltraps>

80105bf4 <vector14>:
.globl vector14
vector14:
  pushl $14
80105bf4:	6a 0e                	push   $0xe
  jmp alltraps
80105bf6:	e9 d5 fa ff ff       	jmp    801056d0 <alltraps>
...
80105bfb:	6a 00                	push   $0x0
  pushl $15
80105bfd:	6a 0f                	push   $0xf
  jmp alltraps
80105bff:	e9 cc fa ff ff       	jmp    801056d0 <alltraps>
...
80105c04:	6a 00                	push   $0x0
  pushl $16
80105c06:	6a 10                	push   $0x10
  jmp alltraps
80105c08:	e9 c3 fa ff ff       	jmp    801056d0 <alltraps>

80105c0d <vector17>:
.globl vector17
vector17:
  pushl $17
80105c0d:	6a 11                	push   $0x11
  jmp alltraps
80105c0f:	e9 bc fa ff ff       	jmp    801056d0 <alltraps>
...
80105c14:	6a 00                	push   $0x0
  pushl $18
80105c16:	6a 12                	push   $0x12
  jmp alltraps
80105c18:	e9 b3 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c1d:	6a 00                	push   $0x0
  pushl $19
80105c1f:	6a 13                	push   $0x13
  jmp alltraps
80105c21:	e9 aa fa ff ff       	jmp    801056d0 <alltraps>
...
80105c26:	6a 00                	push   $0x0
  pushl $20
80105c28:	6a 14                	push   $0x14
  jmp alltraps
80105c2a:	e9 a1 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c2f:	6a 00                	push   $0x0
  pushl $21
80105c31:	6a 15                	push   $0x15
  jmp alltraps
80105c33:	e9 98 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c38:	6a 00                	push   $0x0
  pushl $22
80105c3a:	6a 16                	push   $0x16
  jmp alltraps
80105c3c:	e9 8f fa ff ff       	jmp    801056d0 <alltraps>
...
80105c41:	6a 00                	push   $0x0
  pushl $23
80105c43:	6a 17                	push   $0x17
  jmp alltraps
80105c45:	e9 86 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c4a:	6a 00                	push   $0x0
  pushl $24
80105c4c:	6a 18                	push   $0x18
  jmp alltraps
80105c4e:	e9 7d fa ff ff       	jmp    801056d0 <alltraps>
...
80105c53:	6a 00                	push   $0x0
  pushl $25
80105c55:	6a 19                	push   $0x19
  jmp alltraps
80105c57:	e9 74 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c5c:	6a 00                	push   $0x0
  pushl $26
80105c5e:	6a 1a                	push   $0x1a
  jmp alltraps
80105c60:	e9 6b fa ff ff       	jmp    801056d0 <alltraps>
...
80105c65:	6a 00                	push   $0x0
  pushl $27
80105c67:	6a 1b                	push   $0x1b
  jmp alltraps
80105c69:	e9 62 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c6e:	6a 00                	push   $0x0
  pushl $28
80105c70:	6a 1c                	push   $0x1c
  jmp alltraps
80105c72:	e9 59 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c77:	6a 00                	push   $0x0
  pushl $29
80105c79:	6a 1d                	push   $0x1d
  jmp alltraps
80105c7b:	e9 50 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c80:	6a 00                	push   $0x0
  pushl $30
80105c82:	6a 1e                	push   $0x1e
  jmp alltraps
80105c84:	e9 47 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c89:	6a 00                	push   $0x0
  pushl $31
80105c8b:	6a 1f                	push   $0x1f
  jmp alltraps
80105c8d:	e9 3e fa ff ff       	jmp    801056d0 <alltraps>
...
80105c92:	6a 00                	push   $0x0
  pushl $32
80105c94:	6a 20                	push   $0x20
  jmp alltraps
80105c96:	e9 35 fa ff ff       	jmp    801056d0 <alltraps>
...
80105c9b:	6a 00                	push   $0x0
  pushl $33
80105c9d:	6a 21                	push   $0x21
  jmp alltraps
80105c9f:	e9 2c fa ff ff       	jmp    801056d0 <alltraps>
...
80105ca4:	6a 00                	push   $0x0
  pushl $34
80105ca6:	6a 22                	push   $0x22
  jmp alltraps
80105ca8:	e9 23 fa ff ff       	jmp    801056d0 <alltraps>
...
80105cad:	6a 00                	push   $0x0
  pushl $35
80105caf:	6a 23                	push   $0x23
  jmp alltraps
80105cb1:	e9 1a fa ff ff       	jmp    801056d0 <alltraps>
...
80105cb6:	6a 00                	push   $0x0
  pushl $36
80105cb8:	6a 24                	push   $0x24
  jmp alltraps
80105cba:	e9 11 fa ff ff       	jmp    801056d0 <alltraps>
...
80105cbf:	6a 00                	push   $0x0
  pushl $37
80105cc1:	6a 25                	push   $0x25
  jmp alltraps
80105cc3:	e9 08 fa ff ff       	jmp    801056d0 <alltraps>
...
80105cc8:	6a 00                	push   $0x0
  pushl $38
80105cca:	6a 26                	push   $0x26
  jmp alltraps
80105ccc:	e9 ff f9 ff ff       	jmp    801056d0 <alltraps>
...
80105cd1:	6a 00                	push   $0x0
  pushl $39
80105cd3:	6a 27                	push   $0x27
  jmp alltraps
80105cd5:	e9 f6 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105cda:	6a 00                	push   $0x0
  pushl $40
80105cdc:	6a 28                	push   $0x28
  jmp alltraps
80105cde:	e9 ed f9 ff ff       	jmp    801056d0 <alltraps>
...
80105ce3:	6a 00                	push   $0x0
  pushl $41
80105ce5:	6a 29                	push   $0x29
  jmp alltraps
80105ce7:	e9 e4 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105cec:	6a 00                	push   $0x0
  pushl $42
80105cee:	6a 2a                	push   $0x2a
  jmp alltraps
80105cf0:	e9 db f9 ff ff       	jmp    801056d0 <alltraps>
...
80105cf5:	6a 00                	push   $0x0
  pushl $43
80105cf7:	6a 2b                	push   $0x2b
  jmp alltraps
80105cf9:	e9 d2 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105cfe:	6a 00                	push   $0x0
  pushl $44
80105d00:	6a 2c                	push   $0x2c
  jmp alltraps
80105d02:	e9 c9 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d07:	6a 00                	push   $0x0
  pushl $45
80105d09:	6a 2d                	push   $0x2d
  jmp alltraps
80105d0b:	e9 c0 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d10:	6a 00                	push   $0x0
  pushl $46
80105d12:	6a 2e                	push   $0x2e
  jmp alltraps
80105d14:	e9 b7 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d19:	6a 00                	push   $0x0
  pushl $47
80105d1b:	6a 2f                	push   $0x2f
  jmp alltraps
80105d1d:	e9 ae f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d22:	6a 00                	push   $0x0
  pushl $48
80105d24:	6a 30                	push   $0x30
  jmp alltraps
80105d26:	e9 a5 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d2b:	6a 00                	push   $0x0
  pushl $49
80105d2d:	6a 31                	push   $0x31
  jmp alltraps
80105d2f:	e9 9c f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d34:	6a 00                	push   $0x0
  pushl $50
80105d36:	6a 32                	push   $0x32
  jmp alltraps
80105d38:	e9 93 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d3d:	6a 00                	push   $0x0
  pushl $51
80105d3f:	6a 33                	push   $0x33
  jmp alltraps
80105d41:	e9 8a f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d46:	6a 00                	push   $0x0
  pushl $52
80105d48:	6a 34                	push   $0x34
  jmp alltraps
80105d4a:	e9 81 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d4f:	6a 00                	push   $0x0
  pushl $53
80105d51:	6a 35                	push   $0x35
  jmp alltraps
80105d53:	e9 78 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d58:	6a 00                	push   $0x0
  pushl $54
80105d5a:	6a 36                	push   $0x36
  jmp alltraps
80105d5c:	e9 6f f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d61:	6a 00                	push   $0x0
  pushl $55
80105d63:	6a 37                	push   $0x37
  jmp alltraps
80105d65:	e9 66 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d6a:	6a 00                	push   $0x0
  pushl $56
80105d6c:	6a 38                	push   $0x38
  jmp alltraps
80105d6e:	e9 5d f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d73:	6a 00                	push   $0x0
  pushl $57
80105d75:	6a 39                	push   $0x39
  jmp alltraps
80105d77:	e9 54 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d7c:	6a 00                	push   $0x0
  pushl $58
80105d7e:	6a 3a                	push   $0x3a
  jmp alltraps
80105d80:	e9 4b f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d85:	6a 00                	push   $0x0
  pushl $59
80105d87:	6a 3b                	push   $0x3b
  jmp alltraps
80105d89:	e9 42 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d8e:	6a 00                	push   $0x0
  pushl $60
80105d90:	6a 3c                	push   $0x3c
  jmp alltraps
80105d92:	e9 39 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105d97:	6a 00                	push   $0x0
  pushl $61
80105d99:	6a 3d                	push   $0x3d
  jmp alltraps
80105d9b:	e9 30 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105da0:	6a 00                	push   $0x0
  pushl $62
80105da2:	6a 3e                	push   $0x3e
  jmp alltraps
80105da4:	e9 27 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105da9:	6a 00                	push   $0x0
  pushl $63
80105dab:	6a 3f                	push   $0x3f
  jmp alltraps
80105dad:	e9 1e f9 ff ff       	jmp    801056d0 <alltraps>
...
80105db2:	6a 00                	push   $0x0
  pushl $64
80105db4:	6a 40                	push   $0x40
  jmp alltraps
80105db6:	e9 15 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105dbb:	6a 00                	push   $0x0
  pushl $65
80105dbd:	6a 41                	push   $0x41
  jmp alltraps
80105dbf:	e9 0c f9 ff ff       	jmp    801056d0 <alltraps>
...
80105dc4:	6a 00                	push   $0x0
  pushl $66
80105dc6:	6a 42                	push   $0x42
  jmp alltraps
80105dc8:	e9 03 f9 ff ff       	jmp    801056d0 <alltraps>
...
80105dcd:	6a 00                	push   $0x0
  pushl $67
80105dcf:	6a 43                	push   $0x43
  jmp alltraps
80105dd1:	e9 fa f8 ff ff       	jmp    801056d0 <alltraps>
...
80105dd6:	6a 00                	push   $0x0
  pushl $68
80105dd8:	6a 44                	push   $0x44
  jmp alltraps
80105dda:	e9 f1 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105ddf:	6a 00                	push   $0x0
  pushl $69
80105de1:	6a 45                	push   $0x45
  jmp alltraps
80105de3:	e9 e8 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105de8:	6a 00                	push   $0x0
  pushl $70
80105dea:	6a 46                	push   $0x46
  jmp alltraps
80105dec:	e9 df f8 ff ff       	jmp    801056d0 <alltraps>
...
80105df1:	6a 00                	push   $0x0
  pushl $71
80105df3:	6a 47                	push   $0x47
  jmp alltraps
80105df5:	e9 d6 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105dfa:	6a 00                	push   $0x0
  pushl $72
80105dfc:	6a 48                	push   $0x48
  jmp alltraps
80105dfe:	e9 cd f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e03:	6a 00                	push   $0x0
  pushl $73
80105e05:	6a 49                	push   $0x49
  jmp alltraps
80105e07:	e9 c4 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e0c:	6a 00                	push   $0x0
  pushl $74
80105e0e:	6a 4a                	push   $0x4a
  jmp alltraps
80105e10:	e9 bb f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e15:	6a 00                	push   $0x0
  pushl $75
80105e17:	6a 4b                	push   $0x4b
  jmp alltraps
80105e19:	e9 b2 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e1e:	6a 00                	push   $0x0
  pushl $76
80105e20:	6a 4c                	push   $0x4c
  jmp alltraps
80105e22:	e9 a9 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e27:	6a 00                	push   $0x0
  pushl $77
80105e29:	6a 4d                	push   $0x4d
  jmp alltraps
80105e2b:	e9 a0 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e30:	6a 00                	push   $0x0
  pushl $78
80105e32:	6a 4e                	push   $0x4e
  jmp alltraps
80105e34:	e9 97 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e39:	6a 00                	push   $0x0
  pushl $79
80105e3b:	6a 4f                	push   $0x4f
  jmp alltraps
80105e3d:	e9 8e f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e42:	6a 00                	push   $0x0
  pushl $80
80105e44:	6a 50                	push   $0x50
  jmp alltraps
80105e46:	e9 85 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e4b:	6a 00                	push   $0x0
  pushl $81
80105e4d:	6a 51                	push   $0x51
  jmp alltraps
80105e4f:	e9 7c f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e54:	6a 00                	push   $0x0
  pushl $82
80105e56:	6a 52                	push   $0x52
  jmp alltraps
80105e58:	e9 73 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e5d:	6a 00                	push   $0x0
  pushl $83
80105e5f:	6a 53                	push   $0x53
  jmp alltraps
80105e61:	e9 6a f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e66:	6a 00                	push   $0x0
  pushl $84
80105e68:	6a 54                	push   $0x54
  jmp alltraps
80105e6a:	e9 61 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e6f:	6a 00                	push   $0x0
  pushl $85
80105e71:	6a 55                	push   $0x55
  jmp alltraps
80105e73:	e9 58 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e78:	6a 00                	push   $0x0
  pushl $86
80105e7a:	6a 56                	push   $0x56
  jmp alltraps
80105e7c:	e9 4f f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e81:	6a 00                	push   $0x0
  pushl $87
80105e83:	6a 57                	push   $0x57
  jmp alltraps
80105e85:	e9 46 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e8a:	6a 00                	push   $0x0
  pushl $88
80105e8c:	6a 58                	push   $0x58
  jmp alltraps
80105e8e:	e9 3d f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e93:	6a 00                	push   $0x0
  pushl $89
80105e95:	6a 59                	push   $0x59
  jmp alltraps
80105e97:	e9 34 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105e9c:	6a 00                	push   $0x0
  pushl $90
80105e9e:	6a 5a                	push   $0x5a
  jmp alltraps
80105ea0:	e9 2b f8 ff ff       	jmp    801056d0 <alltraps>
...
80105ea5:	6a 00                	push   $0x0
  pushl $91
80105ea7:	6a 5b                	push   $0x5b
  jmp alltraps
80105ea9:	e9 22 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105eae:	6a 00                	push   $0x0
  pushl $92
80105eb0:	6a 5c                	push   $0x5c
  jmp alltraps
80105eb2:	e9 19 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105eb7:	6a 00                	push   $0x0
  pushl $93
80105eb9:	6a 5d                	push   $0x5d
  jmp alltraps
80105ebb:	e9 10 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105ec0:	6a 00                	push   $0x0
  pushl $94
80105ec2:	6a 5e                	push   $0x5e
  jmp alltraps
80105ec4:	e9 07 f8 ff ff       	jmp    801056d0 <alltraps>
...
80105ec9:	6a 00                	push   $0x0
  pushl $95
80105ecb:	6a 5f                	push   $0x5f
  jmp alltraps
80105ecd:	e9 fe f7 ff ff       	jmp    801056d0 <alltraps>
...
80105ed2:	6a 00                	push   $0x0
  pushl $96
80105ed4:	6a 60                	push   $0x60
  jmp alltraps
80105ed6:	e9 f5 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105edb:	6a 00                	push   $0x0
  pushl $97
80105edd:	6a 61                	push   $0x61
  jmp alltraps
80105edf:	e9 ec f7 ff ff       	jmp    801056d0 <alltraps>
...
80105ee4:	6a 00                	push   $0x0
  pushl $98
80105ee6:	6a 62                	push   $0x62
  jmp alltraps
80105ee8:	e9 e3 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105eed:	6a 00                	push   $0x0
  pushl $99
80105eef:	6a 63                	push   $0x63
  jmp alltraps
80105ef1:	e9 da f7 ff ff       	jmp    801056d0 <alltraps>
...
80105ef6:	6a 00                	push   $0x0
  pushl $100
80105ef8:	6a 64                	push   $0x64
  jmp alltraps
80105efa:	e9 d1 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105eff:	6a 00                	push   $0x0
  pushl $101
80105f01:	6a 65                	push   $0x65
  jmp alltraps
80105f03:	e9 c8 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f08:	6a 00                	push   $0x0
  pushl $102
80105f0a:	6a 66                	push   $0x66
  jmp alltraps
80105f0c:	e9 bf f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f11:	6a 00                	push   $0x0
  pushl $103
80105f13:	6a 67                	push   $0x67
  jmp alltraps
80105f15:	e9 b6 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f1a:	6a 00                	push   $0x0
  pushl $104
80105f1c:	6a 68                	push   $0x68
  jmp alltraps
80105f1e:	e9 ad f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f23:	6a 00                	push   $0x0
  pushl $105
80105f25:	6a 69                	push   $0x69
  jmp alltraps
80105f27:	e9 a4 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f2c:	6a 00                	push   $0x0
  pushl $106
80105f2e:	6a 6a                	push   $0x6a
  jmp alltraps
80105f30:	e9 9b f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f35:	6a 00                	push   $0x0
  pushl $107
80105f37:	6a 6b                	push   $0x6b
  jmp alltraps
80105f39:	e9 92 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f3e:	6a 00                	push   $0x0
  pushl $108
80105f40:	6a 6c                	push   $0x6c
  jmp alltraps
80105f42:	e9 89 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f47:	6a 00                	push   $0x0
  pushl $109
80105f49:	6a 6d                	push   $0x6d
  jmp alltraps
80105f4b:	e9 80 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f50:	6a 00                	push   $0x0
  pushl $110
80105f52:	6a 6e                	push   $0x6e
  jmp alltraps
80105f54:	e9 77 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f59:	6a 00                	push   $0x0
  pushl $111
80105f5b:	6a 6f                	push   $0x6f
  jmp alltraps
80105f5d:	e9 6e f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f62:	6a 00                	push   $0x0
  pushl $112
80105f64:	6a 70                	push   $0x70
  jmp alltraps
80105f66:	e9 65 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f6b:	6a 00                	push   $0x0
  pushl $113
80105f6d:	6a 71                	push   $0x71
  jmp alltraps
80105f6f:	e9 5c f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f74:	6a 00                	push   $0x0
  pushl $114
80105f76:	6a 72                	push   $0x72
  jmp alltraps
80105f78:	e9 53 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f7d:	6a 00                	push   $0x0
  pushl $115
80105f7f:	6a 73                	push   $0x73
  jmp alltraps
80105f81:	e9 4a f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f86:	6a 00                	push   $0x0
  pushl $116
80105f88:	6a 74                	push   $0x74
  jmp alltraps
80105f8a:	e9 41 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f8f:	6a 00                	push   $0x0
  pushl $117
80105f91:	6a 75                	push   $0x75
  jmp alltraps
80105f93:	e9 38 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105f98:	6a 00                	push   $0x0
  pushl $118
80105f9a:	6a 76                	push   $0x76
  jmp alltraps
80105f9c:	e9 2f f7 ff ff       	jmp    801056d0 <alltraps>
...
80105fa1:	6a 00                	push   $0x0
  pushl $119
80105fa3:	6a 77                	push   $0x77
  jmp alltraps
80105fa5:	e9 26 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105faa:	6a 00                	push   $0x0
  pushl $120
80105fac:	6a 78                	push   $0x78
  jmp alltraps
80105fae:	e9 1d f7 ff ff       	jmp    801056d0 <alltraps>
...
80105fb3:	6a 00                	push   $0x0
  pushl $121
80105fb5:	6a 79                	push   $0x79
  jmp alltraps
80105fb7:	e9 14 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105fbc:	6a 00                	push   $0x0
  pushl $122
80105fbe:	6a 7a                	push   $0x7a
  jmp alltraps
80105fc0:	e9 0b f7 ff ff       	jmp    801056d0 <alltraps>
...
80105fc5:	6a 00                	push   $0x0
  pushl $123
80105fc7:	6a 7b                	push   $0x7b
  jmp alltraps
80105fc9:	e9 02 f7 ff ff       	jmp    801056d0 <alltraps>
...
80105fce:	6a 00                	push   $0x0
  pushl $124
80105fd0:	6a 7c                	push   $0x7c
  jmp alltraps
80105fd2:	e9 f9 f6 ff ff       	jmp    801056d0 <alltraps>
...
80105fd7:	6a 00                	push   $0x0
  pushl $125
80105fd9:	6a 7d                	push   $0x7d
  jmp alltraps
80105fdb:	e9 f0 f6 ff ff       	jmp    801056d0 <alltraps>
...
80105fe0:	6a 00                	push   $0x0
  pushl $126
80105fe2:	6a 7e                	push   $0x7e
  jmp alltraps
80105fe4:	e9 e7 f6 ff ff       	jmp    801056d0 <alltraps>
...
80105fe9:	6a 00                	push   $0x0
  pushl $127
80105feb:	6a 7f                	push   $0x7f
  jmp alltraps
80105fed:	e9 de f6 ff ff       	jmp    801056d0 <alltraps>
...
80105ff2:	6a 00                	push   $0x0
  pushl $128
80105ff4:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105ff9:	e9 d2 f6 ff ff       	jmp    801056d0 <alltraps>
...
80105ffe:	6a 00                	push   $0x0
  pushl $129
80106000:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106005:	e9 c6 f6 ff ff       	jmp    801056d0 <alltraps>
...
8010600a:	6a 00                	push   $0x0
  pushl $130
8010600c:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106011:	e9 ba f6 ff ff       	jmp    801056d0 <alltraps>
...
80106016:	6a 00                	push   $0x0
  pushl $131
80106018:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010601d:	e9 ae f6 ff ff       	jmp    801056d0 <alltraps>
...
80106022:	6a 00                	push   $0x0
  pushl $132
80106024:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106029:	e9 a2 f6 ff ff       	jmp    801056d0 <alltraps>
...
8010602e:	6a 00                	push   $0x0
  pushl $133
80106030:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106035:	e9 96 f6 ff ff       	jmp    801056d0 <alltraps>
...
8010603a:	6a 00                	push   $0x0
  pushl $134
8010603c:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106041:	e9 8a f6 ff ff       	jmp    801056d0 <alltraps>
...
80106046:	6a 00                	push   $0x0
  pushl $135
80106048:	68 87 00 00 00       	push   $0x87
  jmp alltraps
8010604d:	e9 7e f6 ff ff       	jmp    801056d0 <alltraps>
...
80106052:	6a 00                	push   $0x0
  pushl $136
80106054:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106059:	e9 72 f6 ff ff       	jmp    801056d0 <alltraps>
...
8010605e:	6a 00                	push   $0x0
  pushl $137
80106060:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106065:	e9 66 f6 ff ff       	jmp    801056d0 <alltraps>
...
8010606a:	6a 00                	push   $0x0
  pushl $138
8010606c:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106071:	e9 5a f6 ff ff       	jmp    801056d0 <alltraps>
...
80106076:	6a 00                	push   $0x0
  pushl $139
80106078:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
8010607d:	e9 4e f6 ff ff       	jmp    801056d0 <alltraps>
...
80106082:	6a 00                	push   $0x0
  pushl $140
80106084:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106089:	e9 42 f6 ff ff       	jmp    801056d0 <alltraps>
...
8010608e:	6a 00                	push   $0x0
  pushl $141
80106090:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106095:	e9 36 f6 ff ff       	jmp    801056d0 <alltraps>
...
8010609a:	6a 00                	push   $0x0
  pushl $142
8010609c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801060a1:	e9 2a f6 ff ff       	jmp    801056d0 <alltraps>
...
801060a6:	6a 00                	push   $0x0
  pushl $143
801060a8:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801060ad:	e9 1e f6 ff ff       	jmp    801056d0 <alltraps>
...
801060b2:	6a 00                	push   $0x0
  pushl $144
801060b4:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801060b9:	e9 12 f6 ff ff       	jmp    801056d0 <alltraps>
...
801060be:	6a 00                	push   $0x0
  pushl $145
801060c0:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801060c5:	e9 06 f6 ff ff       	jmp    801056d0 <alltraps>
...
801060ca:	6a 00                	push   $0x0
  pushl $146
801060cc:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060d1:	e9 fa f5 ff ff       	jmp    801056d0 <alltraps>
...
801060d6:	6a 00                	push   $0x0
  pushl $147
801060d8:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060dd:	e9 ee f5 ff ff       	jmp    801056d0 <alltraps>
...
801060e2:	6a 00                	push   $0x0
  pushl $148
801060e4:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060e9:	e9 e2 f5 ff ff       	jmp    801056d0 <alltraps>
...
801060ee:	6a 00                	push   $0x0
  pushl $149
801060f0:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060f5:	e9 d6 f5 ff ff       	jmp    801056d0 <alltraps>
...
801060fa:	6a 00                	push   $0x0
  pushl $150
801060fc:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106101:	e9 ca f5 ff ff       	jmp    801056d0 <alltraps>
...
80106106:	6a 00                	push   $0x0
  pushl $151
80106108:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010610d:	e9 be f5 ff ff       	jmp    801056d0 <alltraps>
...
80106112:	6a 00                	push   $0x0
  pushl $152
80106114:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106119:	e9 b2 f5 ff ff       	jmp    801056d0 <alltraps>
...
8010611e:	6a 00                	push   $0x0
  pushl $153
80106120:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106125:	e9 a6 f5 ff ff       	jmp    801056d0 <alltraps>
...
8010612a:	6a 00                	push   $0x0
  pushl $154
8010612c:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106131:	e9 9a f5 ff ff       	jmp    801056d0 <alltraps>
...
80106136:	6a 00                	push   $0x0
  pushl $155
80106138:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010613d:	e9 8e f5 ff ff       	jmp    801056d0 <alltraps>
...
80106142:	6a 00                	push   $0x0
  pushl $156
80106144:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106149:	e9 82 f5 ff ff       	jmp    801056d0 <alltraps>
...
8010614e:	6a 00                	push   $0x0
  pushl $157
80106150:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106155:	e9 76 f5 ff ff       	jmp    801056d0 <alltraps>
...
8010615a:	6a 00                	push   $0x0
  pushl $158
8010615c:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106161:	e9 6a f5 ff ff       	jmp    801056d0 <alltraps>
...
80106166:	6a 00                	push   $0x0
  pushl $159
80106168:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010616d:	e9 5e f5 ff ff       	jmp    801056d0 <alltraps>
...
80106172:	6a 00                	push   $0x0
  pushl $160
80106174:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106179:	e9 52 f5 ff ff       	jmp    801056d0 <alltraps>
...
8010617e:	6a 00                	push   $0x0
  pushl $161
80106180:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106185:	e9 46 f5 ff ff       	jmp    801056d0 <alltraps>
...
8010618a:	6a 00                	push   $0x0
  pushl $162
8010618c:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106191:	e9 3a f5 ff ff       	jmp    801056d0 <alltraps>
...
80106196:	6a 00                	push   $0x0
  pushl $163
80106198:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010619d:	e9 2e f5 ff ff       	jmp    801056d0 <alltraps>
...
801061a2:	6a 00                	push   $0x0
  pushl $164
801061a4:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801061a9:	e9 22 f5 ff ff       	jmp    801056d0 <alltraps>
...
801061ae:	6a 00                	push   $0x0
  pushl $165
801061b0:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801061b5:	e9 16 f5 ff ff       	jmp    801056d0 <alltraps>
...
801061ba:	6a 00                	push   $0x0
  pushl $166
801061bc:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801061c1:	e9 0a f5 ff ff       	jmp    801056d0 <alltraps>
...
801061c6:	6a 00                	push   $0x0
  pushl $167
801061c8:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061cd:	e9 fe f4 ff ff       	jmp    801056d0 <alltraps>
...
801061d2:	6a 00                	push   $0x0
  pushl $168
801061d4:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061d9:	e9 f2 f4 ff ff       	jmp    801056d0 <alltraps>
...
801061de:	6a 00                	push   $0x0
  pushl $169
801061e0:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061e5:	e9 e6 f4 ff ff       	jmp    801056d0 <alltraps>
...
801061ea:	6a 00                	push   $0x0
  pushl $170
801061ec:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061f1:	e9 da f4 ff ff       	jmp    801056d0 <alltraps>
...
801061f6:	6a 00                	push   $0x0
  pushl $171
801061f8:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061fd:	e9 ce f4 ff ff       	jmp    801056d0 <alltraps>
...
80106202:	6a 00                	push   $0x0
  pushl $172
80106204:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106209:	e9 c2 f4 ff ff       	jmp    801056d0 <alltraps>
...
8010620e:	6a 00                	push   $0x0
  pushl $173
80106210:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106215:	e9 b6 f4 ff ff       	jmp    801056d0 <alltraps>
...
8010621a:	6a 00                	push   $0x0
  pushl $174
8010621c:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106221:	e9 aa f4 ff ff       	jmp    801056d0 <alltraps>
...
80106226:	6a 00                	push   $0x0
  pushl $175
80106228:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010622d:	e9 9e f4 ff ff       	jmp    801056d0 <alltraps>
...
80106232:	6a 00                	push   $0x0
  pushl $176
80106234:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106239:	e9 92 f4 ff ff       	jmp    801056d0 <alltraps>
...
8010623e:	6a 00                	push   $0x0
  pushl $177
80106240:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106245:	e9 86 f4 ff ff       	jmp    801056d0 <alltraps>
...
8010624a:	6a 00                	push   $0x0
  pushl $178
8010624c:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106251:	e9 7a f4 ff ff       	jmp    801056d0 <alltraps>
...
80106256:	6a 00                	push   $0x0
  pushl $179
80106258:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010625d:	e9 6e f4 ff ff       	jmp    801056d0 <alltraps>
...
80106262:	6a 00                	push   $0x0
  pushl $180
80106264:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106269:	e9 62 f4 ff ff       	jmp    801056d0 <alltraps>
...
8010626e:	6a 00                	push   $0x0
  pushl $181
80106270:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106275:	e9 56 f4 ff ff       	jmp    801056d0 <alltraps>
...
8010627a:	6a 00                	push   $0x0
  pushl $182
8010627c:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106281:	e9 4a f4 ff ff       	jmp    801056d0 <alltraps>
...
80106286:	6a 00                	push   $0x0
  pushl $183
80106288:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010628d:	e9 3e f4 ff ff       	jmp    801056d0 <alltraps>
...
80106292:	6a 00                	push   $0x0
  pushl $184
80106294:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106299:	e9 32 f4 ff ff       	jmp    801056d0 <alltraps>
...
8010629e:	6a 00                	push   $0x0
  pushl $185
801062a0:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801062a5:	e9 26 f4 ff ff       	jmp    801056d0 <alltraps>
...
801062aa:	6a 00                	push   $0x0
  pushl $186
801062ac:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801062b1:	e9 1a f4 ff ff       	jmp    801056d0 <alltraps>
...
801062b6:	6a 00                	push   $0x0
  pushl $187
801062b8:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801062bd:	e9 0e f4 ff ff       	jmp    801056d0 <alltraps>
...
801062c2:	6a 00                	push   $0x0
  pushl $188
801062c4:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801062c9:	e9 02 f4 ff ff       	jmp    801056d0 <alltraps>
...
801062ce:	6a 00                	push   $0x0
  pushl $189
801062d0:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062d5:	e9 f6 f3 ff ff       	jmp    801056d0 <alltraps>
...
801062da:	6a 00                	push   $0x0
  pushl $190
801062dc:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062e1:	e9 ea f3 ff ff       	jmp    801056d0 <alltraps>
...
801062e6:	6a 00                	push   $0x0
  pushl $191
801062e8:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062ed:	e9 de f3 ff ff       	jmp    801056d0 <alltraps>
...
801062f2:	6a 00                	push   $0x0
  pushl $192
801062f4:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062f9:	e9 d2 f3 ff ff       	jmp    801056d0 <alltraps>
...
801062fe:	6a 00                	push   $0x0
  pushl $193
80106300:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106305:	e9 c6 f3 ff ff       	jmp    801056d0 <alltraps>
...
8010630a:	6a 00                	push   $0x0
  pushl $194
8010630c:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106311:	e9 ba f3 ff ff       	jmp    801056d0 <alltraps>
...
80106316:	6a 00                	push   $0x0
  pushl $195
80106318:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010631d:	e9 ae f3 ff ff       	jmp    801056d0 <alltraps>
...
80106322:	6a 00                	push   $0x0
  pushl $196
80106324:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106329:	e9 a2 f3 ff ff       	jmp    801056d0 <alltraps>
...
8010632e:	6a 00                	push   $0x0
  pushl $197
80106330:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106335:	e9 96 f3 ff ff       	jmp    801056d0 <alltraps>
...
8010633a:	6a 00                	push   $0x0
  pushl $198
8010633c:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106341:	e9 8a f3 ff ff       	jmp    801056d0 <alltraps>
...
80106346:	6a 00                	push   $0x0
  pushl $199
80106348:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010634d:	e9 7e f3 ff ff       	jmp    801056d0 <alltraps>
...
80106352:	6a 00                	push   $0x0
  pushl $200
80106354:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106359:	e9 72 f3 ff ff       	jmp    801056d0 <alltraps>
...
8010635e:	6a 00                	push   $0x0
  pushl $201
80106360:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106365:	e9 66 f3 ff ff       	jmp    801056d0 <alltraps>
...
8010636a:	6a 00                	push   $0x0
  pushl $202
8010636c:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106371:	e9 5a f3 ff ff       	jmp    801056d0 <alltraps>
...
80106376:	6a 00                	push   $0x0
  pushl $203
80106378:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
8010637d:	e9 4e f3 ff ff       	jmp    801056d0 <alltraps>
...
80106382:	6a 00                	push   $0x0
  pushl $204
80106384:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106389:	e9 42 f3 ff ff       	jmp    801056d0 <alltraps>
...
8010638e:	6a 00                	push   $0x0
  pushl $205
80106390:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106395:	e9 36 f3 ff ff       	jmp    801056d0 <alltraps>
...
8010639a:	6a 00                	push   $0x0
  pushl $206
8010639c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801063a1:	e9 2a f3 ff ff       	jmp    801056d0 <alltraps>
...
801063a6:	6a 00                	push   $0x0
  pushl $207
801063a8:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801063ad:	e9 1e f3 ff ff       	jmp    801056d0 <alltraps>
...
801063b2:	6a 00                	push   $0x0
  pushl $208
801063b4:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801063b9:	e9 12 f3 ff ff       	jmp    801056d0 <alltraps>
...
801063be:	6a 00                	push   $0x0
  pushl $209
801063c0:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801063c5:	e9 06 f3 ff ff       	jmp    801056d0 <alltraps>
...
801063ca:	6a 00                	push   $0x0
  pushl $210
801063cc:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063d1:	e9 fa f2 ff ff       	jmp    801056d0 <alltraps>
...
801063d6:	6a 00                	push   $0x0
  pushl $211
801063d8:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063dd:	e9 ee f2 ff ff       	jmp    801056d0 <alltraps>
...
801063e2:	6a 00                	push   $0x0
  pushl $212
801063e4:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063e9:	e9 e2 f2 ff ff       	jmp    801056d0 <alltraps>
...
801063ee:	6a 00                	push   $0x0
  pushl $213
801063f0:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063f5:	e9 d6 f2 ff ff       	jmp    801056d0 <alltraps>
...
801063fa:	6a 00                	push   $0x0
  pushl $214
801063fc:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106401:	e9 ca f2 ff ff       	jmp    801056d0 <alltraps>
...
80106406:	6a 00                	push   $0x0
  pushl $215
80106408:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
8010640d:	e9 be f2 ff ff       	jmp    801056d0 <alltraps>
...
80106412:	6a 00                	push   $0x0
  pushl $216
80106414:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106419:	e9 b2 f2 ff ff       	jmp    801056d0 <alltraps>
...
8010641e:	6a 00                	push   $0x0
  pushl $217
80106420:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106425:	e9 a6 f2 ff ff       	jmp    801056d0 <alltraps>
...
8010642a:	6a 00                	push   $0x0
  pushl $218
8010642c:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106431:	e9 9a f2 ff ff       	jmp    801056d0 <alltraps>
...
80106436:	6a 00                	push   $0x0
  pushl $219
80106438:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010643d:	e9 8e f2 ff ff       	jmp    801056d0 <alltraps>
...
80106442:	6a 00                	push   $0x0
  pushl $220
80106444:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106449:	e9 82 f2 ff ff       	jmp    801056d0 <alltraps>
...
8010644e:	6a 00                	push   $0x0
  pushl $221
80106450:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106455:	e9 76 f2 ff ff       	jmp    801056d0 <alltraps>
...
8010645a:	6a 00                	push   $0x0
  pushl $222
8010645c:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106461:	e9 6a f2 ff ff       	jmp    801056d0 <alltraps>
...
80106466:	6a 00                	push   $0x0
  pushl $223
80106468:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
8010646d:	e9 5e f2 ff ff       	jmp    801056d0 <alltraps>
...
80106472:	6a 00                	push   $0x0
  pushl $224
80106474:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106479:	e9 52 f2 ff ff       	jmp    801056d0 <alltraps>
...
8010647e:	6a 00                	push   $0x0
  pushl $225
80106480:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106485:	e9 46 f2 ff ff       	jmp    801056d0 <alltraps>
...
8010648a:	6a 00                	push   $0x0
  pushl $226
8010648c:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106491:	e9 3a f2 ff ff       	jmp    801056d0 <alltraps>
...
80106496:	6a 00                	push   $0x0
  pushl $227
80106498:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010649d:	e9 2e f2 ff ff       	jmp    801056d0 <alltraps>
...
801064a2:	6a 00                	push   $0x0
  pushl $228
801064a4:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801064a9:	e9 22 f2 ff ff       	jmp    801056d0 <alltraps>
...
801064ae:	6a 00                	push   $0x0
  pushl $229
801064b0:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801064b5:	e9 16 f2 ff ff       	jmp    801056d0 <alltraps>
...
801064ba:	6a 00                	push   $0x0
  pushl $230
801064bc:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801064c1:	e9 0a f2 ff ff       	jmp    801056d0 <alltraps>
...
801064c6:	6a 00                	push   $0x0
  pushl $231
801064c8:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064cd:	e9 fe f1 ff ff       	jmp    801056d0 <alltraps>
...
801064d2:	6a 00                	push   $0x0
  pushl $232
801064d4:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064d9:	e9 f2 f1 ff ff       	jmp    801056d0 <alltraps>
...
801064de:	6a 00                	push   $0x0
  pushl $233
801064e0:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064e5:	e9 e6 f1 ff ff       	jmp    801056d0 <alltraps>
...
801064ea:	6a 00                	push   $0x0
  pushl $234
801064ec:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064f1:	e9 da f1 ff ff       	jmp    801056d0 <alltraps>
...
801064f6:	6a 00                	push   $0x0
  pushl $235
801064f8:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064fd:	e9 ce f1 ff ff       	jmp    801056d0 <alltraps>
...
80106502:	6a 00                	push   $0x0
  pushl $236
80106504:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106509:	e9 c2 f1 ff ff       	jmp    801056d0 <alltraps>
...
8010650e:	6a 00                	push   $0x0
  pushl $237
80106510:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106515:	e9 b6 f1 ff ff       	jmp    801056d0 <alltraps>
...
8010651a:	6a 00                	push   $0x0
  pushl $238
8010651c:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106521:	e9 aa f1 ff ff       	jmp    801056d0 <alltraps>
...
80106526:	6a 00                	push   $0x0
  pushl $239
80106528:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
8010652d:	e9 9e f1 ff ff       	jmp    801056d0 <alltraps>
...
80106532:	6a 00                	push   $0x0
  pushl $240
80106534:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106539:	e9 92 f1 ff ff       	jmp    801056d0 <alltraps>
...
8010653e:	6a 00                	push   $0x0
  pushl $241
80106540:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106545:	e9 86 f1 ff ff       	jmp    801056d0 <alltraps>
...
8010654a:	6a 00                	push   $0x0
  pushl $242
8010654c:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106551:	e9 7a f1 ff ff       	jmp    801056d0 <alltraps>
...
80106556:	6a 00                	push   $0x0
  pushl $243
80106558:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010655d:	e9 6e f1 ff ff       	jmp    801056d0 <alltraps>
...
80106562:	6a 00                	push   $0x0
  pushl $244
80106564:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106569:	e9 62 f1 ff ff       	jmp    801056d0 <alltraps>
...
8010656e:	6a 00                	push   $0x0
  pushl $245
80106570:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106575:	e9 56 f1 ff ff       	jmp    801056d0 <alltraps>
...
8010657a:	6a 00                	push   $0x0
  pushl $246
8010657c:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106581:	e9 4a f1 ff ff       	jmp    801056d0 <alltraps>
...
80106586:	6a 00                	push   $0x0
  pushl $247
80106588:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010658d:	e9 3e f1 ff ff       	jmp    801056d0 <alltraps>
...
80106592:	6a 00                	push   $0x0
  pushl $248
80106594:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106599:	e9 32 f1 ff ff       	jmp    801056d0 <alltraps>
...
8010659e:	6a 00                	push   $0x0
  pushl $249
801065a0:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801065a5:	e9 26 f1 ff ff       	jmp    801056d0 <alltraps>
...
801065aa:	6a 00                	push   $0x0
  pushl $250
801065ac:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801065b1:	e9 1a f1 ff ff       	jmp    801056d0 <alltraps>
...
801065b6:	6a 00                	push   $0x0
  pushl $251
801065b8:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801065bd:	e9 0e f1 ff ff       	jmp    801056d0 <alltraps>
...
801065c2:	6a 00                	push   $0x0
  pushl $252
801065c4:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801065c9:	e9 02 f1 ff ff       	jmp    801056d0 <alltraps>
...
801065ce:	6a 00                	push   $0x0
  pushl $253
801065d0:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065d5:	e9 f6 f0 ff ff       	jmp    801056d0 <alltraps>
...
801065da:	6a 00                	push   $0x0
  pushl $254
801065dc:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065e1:	e9 ea f0 ff ff       	jmp    801056d0 <alltraps>
...
801065e6:	6a 00                	push   $0x0
  pushl $255
801065e8:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065ed:	e9 de f0 ff ff       	jmp    801056d0 <alltraps>
	...
...
80106600:	a1 24 56 11 80       	mov    0x80115624,%eax
...
80106608:	2d 00 00 00 80       	sub    $0x80000000,%eax
...
80106623:	83 ec 28             	sub    $0x28,%esp
80106626:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80106629:	89 d3                	mov    %edx,%ebx
8010662b:	c1 eb 16             	shr    $0x16,%ebx
8010662e:	8d 1c 98             	lea    (%eax,%ebx,4),%ebx
// Return the address of the PTE in page table pgdir
// that corresponds to virtual address va.  If alloc!=0,
// create any required page table pages.
static pte_t *
walkpgdir(pde_t *pgdir, const void *va, int alloc)
{
80106631:	89 75 fc             	mov    %esi,-0x4(%ebp)
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
  if(*pde & PTE_P){
80106634:	8b 33                	mov    (%ebx),%esi
80106636:	f7 c6 01 00 00 00    	test   $0x1,%esi
8010663c:	74 22                	je     80106660 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010663e:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106644:	81 ee 00 00 00 80    	sub    $0x80000000,%esi
  ...
  return &pgtab[PTX(va)];
8010664a:	c1 ea 0a             	shr    $0xa,%edx
8010664d:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80106653:	8d 04 16             	lea    (%esi,%edx,1),%eax
}
80106656:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80106659:	8b 75 fc             	mov    -0x4(%ebp),%esi
8010665c:	89 ec                	mov    %ebp,%esp
8010665e:	5d                   	pop    %ebp
8010665f:	c3                   	ret    
...
80106662:	75 04                	jne    80106668 <walkpgdir+0x48>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106666:	eb ee                	jmp    80106656 <walkpgdir+0x36>
  ...
  if(*pde & PTE_P){
    ...
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106668:	89 55 f4             	mov    %edx,-0xc(%ebp)
8010666b:	e8 f0 bc ff ff       	call   80102360 <kalloc>
80106670:	85 c0                	test   %eax,%eax
80106672:	89 c6                	mov    %eax,%esi
80106674:	74 ee                	je     80106664 <walkpgdir+0x44>
      return 0;
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80106676:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010667d:	00 
8010667e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106685:	00 
80106686:	89 04 24             	mov    %eax,(%esp)
80106689:	e8 02 de ff ff       	call   80104490 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010668e:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106694:	83 c8 07             	or     $0x7,%eax
80106697:	89 03                	mov    %eax,(%ebx)
80106699:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010669c:	eb ac                	jmp    8010664a <walkpgdir+0x2a>
...
801066ae:	e8 6d ff ff ff       	call   80106620 <walkpgdir>
  if((*pte & PTE_P) == 0)
801066b3:	8b 00                	mov    (%eax),%eax
801066b5:	a8 01                	test   $0x1,%al
801066b7:	75 07                	jne    801066c0 <uva2ka+0x20>
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
801066c2:	74 f5                	je     801066b9 <uva2ka+0x19>
    return 0;
  return (char*)P2V(PTE_ADDR(*pte));
801066c4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801066c9:	2d 00 00 00 80       	sub    $0x80000000,%eax
}
801066ce:	c9                   	leave  
801066cf:	c3                   	ret    
...
801066f2:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
801066f5:	29 d7                	sub    %edx,%edi
801066f7:	81 c7 00 10 00 00    	add    $0x1000,%edi
801066fd:	39 df                	cmp    %ebx,%edi
801066ff:	0f 47 fb             	cmova  %ebx,%edi
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80106702:	29 f2                	sub    %esi,%edx
80106704:	8d 14 10             	lea    (%eax,%edx,1),%edx
80106707:	89 7c 24 08          	mov    %edi,0x8(%esp)
8010670b:	89 4c 24 04          	mov    %ecx,0x4(%esp)
8010670f:	89 14 24             	mov    %edx,(%esp)
80106712:	e8 49 de ff ff       	call   80104560 <memmove>
{
  char *buf, *pa0;
  uint n, va0;
...
8010671e:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
  ...
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
80106724:	8b 4d 08             	mov    0x8(%ebp),%ecx
  char *buf, *pa0;
  uint n, va0;
...
80106729:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
8010672f:	89 55 e0             	mov    %edx,-0x20(%ebp)
80106732:	89 74 24 04          	mov    %esi,0x4(%esp)
80106736:	89 0c 24             	mov    %ecx,(%esp)
80106739:	e8 62 ff ff ff       	call   801066a0 <uva2ka>
    if(pa0 == 0)
...
80106778:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
// Create PTEs for virtual addresses starting at va that refer to
// physical addresses starting at pa. va and size might not
// be page-aligned.
static int
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
8010677c:	83 ec 2c             	sub    $0x2c,%esp
8010677f:	8b 75 08             	mov    0x8(%ebp),%esi
80106782:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80106785:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010678b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80106791:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
80106795:	eb 1d                	jmp    801067b4 <mappages+0x44>
80106797:	90                   	nop
  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
80106798:	f6 00 01             	testb  $0x1,(%eax)
8010679b:	75 45                	jne    801067e2 <mappages+0x72>
      panic("remap");
    *pte = pa | perm | PTE_P;
8010679d:	8b 55 0c             	mov    0xc(%ebp),%edx
801067a0:	09 f2                	or     %esi,%edx
    if(a == last)
801067a2:	39 fb                	cmp    %edi,%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
801067a4:	89 10                	mov    %edx,(%eax)
    if(a == last)
801067a6:	74 30                	je     801067d8 <mappages+0x68>
      break;
    a += PGSIZE;
801067a8:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
801067ae:	81 c6 00 10 00 00    	add    $0x1000,%esi
  pte_t *pte;
...
801067b7:	b9 01 00 00 00       	mov    $0x1,%ecx
801067bc:	89 da                	mov    %ebx,%edx
801067be:	e8 5d fe ff ff       	call   80106620 <walkpgdir>
801067c3:	85 c0                	test   %eax,%eax
801067c5:	75 d1                	jne    80106798 <mappages+0x28>
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
...
801067c7:	83 c4 2c             	add    $0x2c,%esp
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
...
801067d8:	83 c4 2c             	add    $0x2c,%esp
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
      panic("remap");
...
801067e1:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
801067e2:	c7 04 24 d0 77 10 80 	movl   $0x801077d0,(%esp)
801067e9:	e8 e2 9b ff ff       	call   801003d0 <panic>
...
801067f8:	e8 63 bb ff ff       	call   80102360 <kalloc>
801067fd:	85 c0                	test   %eax,%eax
801067ff:	89 c6                	mov    %eax,%esi
80106801:	74 53                	je     80106856 <setupkvm+0x66>
    return 0;
  memset(pgdir, 0, PGSIZE);
80106803:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010680a:	00 
8010680b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106812:	00 
80106813:	89 04 24             	mov    %eax,(%esp)
80106816:	e8 75 dc ff ff       	call   80104490 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010681b:	b8 60 a4 10 80       	mov    $0x8010a460,%eax
80106820:	3d 20 a4 10 80       	cmp    $0x8010a420,%eax
80106825:	76 2f                	jbe    80106856 <setupkvm+0x66>
...
pde_t*
setupkvm(void)
80106827:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
...
8010682c:	8b 53 0c             	mov    0xc(%ebx),%edx
8010682f:	8b 43 04             	mov    0x4(%ebx),%eax
80106832:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106835:	89 54 24 04          	mov    %edx,0x4(%esp)
80106839:	8b 13                	mov    (%ebx),%edx
8010683b:	89 04 24             	mov    %eax,(%esp)
8010683e:	29 c1                	sub    %eax,%ecx
80106840:	89 f0                	mov    %esi,%eax
80106842:	e8 29 ff ff ff       	call   80106770 <mappages>
80106847:	85 c0                	test   %eax,%eax
80106849:	78 15                	js     80106860 <setupkvm+0x70>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010684b:	83 c3 10             	add    $0x10,%ebx
8010684e:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106854:	75 d6                	jne    8010682c <setupkvm+0x3c>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
...
80106873:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106876:	e8 75 ff ff ff       	call   801067f0 <setupkvm>
8010687b:	a3 24 56 11 80       	mov    %eax,0x80115624
80106880:	2d 00 00 00 80       	sub    $0x80000000,%eax
80106885:	0f 22 d8             	mov    %eax,%cr3
  switchkvm();
}
80106888:	c9                   	leave  
80106889:	c3                   	ret    
...
80106895:	83 ec 18             	sub    $0x18,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80106898:	8b 55 0c             	mov    0xc(%ebp),%edx
8010689b:	8b 45 08             	mov    0x8(%ebp),%eax
8010689e:	e8 7d fd ff ff       	call   80106620 <walkpgdir>
  if(pte == 0)
801068a3:	85 c0                	test   %eax,%eax
801068a5:	74 05                	je     801068ac <clearpteu+0x1c>
    panic("clearpteu");
  *pte &= ~PTE_U;
801068a7:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801068aa:	c9                   	leave  
801068ab:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
801068ac:	c7 04 24 d6 77 10 80 	movl   $0x801077d6,(%esp)
801068b3:	e8 18 9b ff ff       	call   801003d0 <panic>
801068b8:	90                   	nop
...
801068c6:	89 75 f8             	mov    %esi,-0x8(%ebp)
801068c9:	8b 75 10             	mov    0x10(%ebp),%esi
801068cc:	8b 45 08             	mov    0x8(%ebp),%eax
801068cf:	89 7d fc             	mov    %edi,-0x4(%ebp)
801068d2:	8b 7d 0c             	mov    0xc(%ebp),%edi
801068d5:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  char *mem;

  if(sz >= PGSIZE)
801068d8:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
...
801068de:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  if(sz >= PGSIZE)
801068e1:	77 59                	ja     8010693c <inituvm+0x7c>
    panic("inituvm: more than a page");
  mem = kalloc();
801068e3:	e8 78 ba ff ff       	call   80102360 <kalloc>
  memset(mem, 0, PGSIZE);
...
801068f7:	00 
{
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
801068f8:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801068fa:	89 04 24             	mov    %eax,(%esp)
801068fd:	e8 8e db ff ff       	call   80104490 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106902:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106908:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010690d:	89 04 24             	mov    %eax,(%esp)
80106910:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106913:	31 d2                	xor    %edx,%edx
80106915:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
8010691c:	00 
8010691d:	e8 4e fe ff ff       	call   80106770 <mappages>
  memmove(mem, init, sz);
80106922:	89 75 10             	mov    %esi,0x10(%ebp)
}
80106925:	8b 75 f8             	mov    -0x8(%ebp),%esi
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106928:	89 7d 0c             	mov    %edi,0xc(%ebp)
}
8010692b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
  memset(mem, 0, PGSIZE);
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010692e:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80106931:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80106934:	89 ec                	mov    %ebp,%esp
80106936:	5d                   	pop    %ebp
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106937:	e9 24 dc ff ff       	jmp    80104560 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
8010693c:	c7 04 24 e0 77 10 80 	movl   $0x801077e0,(%esp)
80106943:	e8 88 9a ff ff       	call   801003d0 <panic>
80106948:	90                   	nop
...
80106959:	8b 75 0c             	mov    0xc(%ebp),%esi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
8010695c:	39 75 10             	cmp    %esi,0x10(%ebp)
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
...
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  ...
  if(newsz >= oldsz)
80106964:	73 75                	jae    801069db <deallocuvm+0x8b>
    return oldsz;

  a = PGROUNDUP(newsz);
80106966:	8b 5d 10             	mov    0x10(%ebp),%ebx
80106969:	81 c3 ff 0f 00 00    	add    $0xfff,%ebx
8010696f:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106975:	39 de                	cmp    %ebx,%esi
80106977:	77 3a                	ja     801069b3 <deallocuvm+0x63>
80106979:	eb 5d                	jmp    801069d8 <deallocuvm+0x88>
8010697b:	90                   	nop
...
80106980:	8b 10                	mov    (%eax),%edx
80106982:	f6 c2 01             	test   $0x1,%dl
80106985:	74 22                	je     801069a9 <deallocuvm+0x59>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106987:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
8010698d:	74 54                	je     801069e3 <deallocuvm+0x93>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
8010698f:	81 ea 00 00 00 80    	sub    $0x80000000,%edx
80106995:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106998:	89 14 24             	mov    %edx,(%esp)
8010699b:	e8 10 ba ff ff       	call   801023b0 <kfree>
      *pte = 0;
801069a0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801069a3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801069a9:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801069af:	39 de                	cmp    %ebx,%esi
801069b1:	76 25                	jbe    801069d8 <deallocuvm+0x88>
    pte = walkpgdir(pgdir, (char*)a, 0);
801069b3:	31 c9                	xor    %ecx,%ecx
801069b5:	89 da                	mov    %ebx,%edx
801069b7:	89 f8                	mov    %edi,%eax
801069b9:	e8 62 fc ff ff       	call   80106620 <walkpgdir>
    if(!pte)
801069be:	85 c0                	test   %eax,%eax
801069c0:	75 be                	jne    80106980 <deallocuvm+0x30>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801069c2:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
801069c8:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801069ce:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801069d4:	39 de                	cmp    %ebx,%esi
801069d6:	77 db                	ja     801069b3 <deallocuvm+0x63>
      char *v = P2V(pa);
      kfree(v);
      *pte = 0;
    }
...
801069db:	83 c4 2c             	add    $0x2c,%esp
801069de:	5b                   	pop    %ebx
801069df:	5e                   	pop    %esi
801069e0:	5f                   	pop    %edi
801069e1:	5d                   	pop    %ebp
801069e2:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
801069e3:	c7 04 24 92 71 10 80 	movl   $0x80107192,(%esp)
801069ea:	e8 e1 99 ff ff       	call   801003d0 <panic>
801069ef:	90                   	nop
...
801069f8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  uint i;

  if(pgdir == 0)
801069fb:	85 db                	test   %ebx,%ebx
801069fd:	74 5e                	je     80106a5d <freevm+0x6d>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
801069ff:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106a06:	00 
80106a07:	31 f6                	xor    %esi,%esi
80106a09:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80106a10:	80 
80106a11:	89 1c 24             	mov    %ebx,(%esp)
80106a14:	e8 37 ff ff ff       	call   80106950 <deallocuvm>
80106a19:	eb 10                	jmp    80106a2b <freevm+0x3b>
80106a1b:	90                   	nop
80106a1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(i = 0; i < NPDENTRIES; i++){
80106a20:	83 c6 01             	add    $0x1,%esi
80106a23:	81 fe 00 04 00 00    	cmp    $0x400,%esi
80106a29:	74 24                	je     80106a4f <freevm+0x5f>
    if(pgdir[i] & PTE_P){
80106a2b:	8b 04 b3             	mov    (%ebx,%esi,4),%eax
80106a2e:	a8 01                	test   $0x1,%al
80106a30:	74 ee                	je     80106a20 <freevm+0x30>
...
80106a32:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106a37:	83 c6 01             	add    $0x1,%esi
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
      kfree(v);
80106a3a:	2d 00 00 00 80       	sub    $0x80000000,%eax
80106a3f:	89 04 24             	mov    %eax,(%esp)
80106a42:	e8 69 b9 ff ff       	call   801023b0 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106a47:	81 fe 00 04 00 00    	cmp    $0x400,%esi
80106a4d:	75 dc                	jne    80106a2b <freevm+0x3b>
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
  ...
  kfree((char*)pgdir);
80106a4f:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80106a57:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106a58:	e9 53 b9 ff ff       	jmp    801023b0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106a5d:	c7 04 24 fa 77 10 80 	movl   $0x801077fa,(%esp)
80106a64:	e8 67 99 ff ff       	call   801003d0 <panic>
...
80106a76:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106a79:	e8 72 fd ff ff       	call   801067f0 <setupkvm>
80106a7e:	85 c0                	test   %eax,%eax
80106a80:	89 c6                	mov    %eax,%esi
80106a82:	0f 84 91 00 00 00    	je     80106b19 <copyuvm+0xa9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106a88:	8b 45 0c             	mov    0xc(%ebp),%eax
80106a8b:	85 c0                	test   %eax,%eax
80106a8d:	0f 84 86 00 00 00    	je     80106b19 <copyuvm+0xa9>
80106a93:	31 db                	xor    %ebx,%ebx
80106a95:	eb 54                	jmp    80106aeb <copyuvm+0x7b>
80106a97:	90                   	nop
...
80106a9b:	89 3c 24             	mov    %edi,(%esp)
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106a9e:	81 ef 00 00 00 80    	sub    $0x80000000,%edi
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106aa4:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106aab:	00 
80106aac:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106ab1:	2d 00 00 00 80       	sub    $0x80000000,%eax
80106ab6:	89 44 24 04          	mov    %eax,0x4(%esp)
80106aba:	e8 a1 da ff ff       	call   80104560 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106abf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ac2:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106ac7:	89 da                	mov    %ebx,%edx
80106ac9:	89 3c 24             	mov    %edi,(%esp)
80106acc:	25 ff 0f 00 00       	and    $0xfff,%eax
...
80106ade:	78 2f                	js     80106b0f <copyuvm+0x9f>
  uint pa, i, flags;
  char *mem;
...
80106ae6:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106ae9:	76 2e                	jbe    80106b19 <copyuvm+0xa9>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106aeb:	8b 45 08             	mov    0x8(%ebp),%eax
80106aee:	31 c9                	xor    %ecx,%ecx
80106af0:	89 da                	mov    %ebx,%edx
80106af2:	e8 29 fb ff ff       	call   80106620 <walkpgdir>
80106af7:	85 c0                	test   %eax,%eax
80106af9:	74 28                	je     80106b23 <copyuvm+0xb3>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106afb:	8b 00                	mov    (%eax),%eax
80106afd:	a8 01                	test   $0x1,%al
80106aff:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b02:	74 2b                	je     80106b2f <copyuvm+0xbf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106b04:	e8 57 b8 ff ff       	call   80102360 <kalloc>
80106b09:	85 c0                	test   %eax,%eax
80106b0b:	89 c7                	mov    %eax,%edi
80106b0d:	75 89                	jne    80106a98 <copyuvm+0x28>
      goto bad;
  }
  return d;
...
bad:
  freevm(d);
80106b0f:	89 34 24             	mov    %esi,(%esp)
80106b12:	31 f6                	xor    %esi,%esi
80106b14:	e8 d7 fe ff ff       	call   801069f0 <freevm>
  return 0;
}
80106b19:	83 c4 2c             	add    $0x2c,%esp
80106b1c:	89 f0                	mov    %esi,%eax
80106b1e:	5b                   	pop    %ebx
80106b1f:	5e                   	pop    %esi
80106b20:	5f                   	pop    %edi
80106b21:	5d                   	pop    %ebp
80106b22:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106b23:	c7 04 24 0b 78 10 80 	movl   $0x8010780b,(%esp)
80106b2a:	e8 a1 98 ff ff       	call   801003d0 <panic>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106b2f:	c7 04 24 25 78 10 80 	movl   $0x80107825,(%esp)
80106b36:	e8 95 98 ff ff       	call   801003d0 <panic>
80106b3b:	90                   	nop
...
80106b4e:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106b51:	0f 88 9c 00 00 00    	js     80106bf3 <allocuvm+0xb3>
    return 0;
  if(newsz < oldsz)
80106b57:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b5a:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
80106b5d:	0f 82 a5 00 00 00    	jb     80106c08 <allocuvm+0xc8>
    return oldsz;

  a = PGROUNDUP(oldsz);
80106b63:	8b 75 0c             	mov    0xc(%ebp),%esi
80106b66:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
80106b6c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106b72:	39 f7                	cmp    %esi,%edi
80106b74:	77 50                	ja     80106bc6 <allocuvm+0x86>
80106b76:	e9 90 00 00 00       	jmp    80106c0b <allocuvm+0xcb>
80106b7b:	90                   	nop
80106b7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    memset(mem, 0, PGSIZE);
80106b80:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b87:	00 
80106b88:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b8f:	00 
80106b90:	89 04 24             	mov    %eax,(%esp)
80106b93:	e8 f8 d8 ff ff       	call   80104490 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106b98:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106b9e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106ba3:	89 04 24             	mov    %eax,(%esp)
80106ba6:	8b 45 08             	mov    0x8(%ebp),%eax
80106ba9:	89 f2                	mov    %esi,%edx
80106bab:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106bb2:	00 
80106bb3:	e8 b8 fb ff ff       	call   80106770 <mappages>
80106bb8:	85 c0                	test   %eax,%eax
80106bba:	78 5c                	js     80106c18 <allocuvm+0xd8>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80106bbc:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106bc2:	39 f7                	cmp    %esi,%edi
80106bc4:	76 45                	jbe    80106c0b <allocuvm+0xcb>
    mem = kalloc();
80106bc6:	e8 95 b7 ff ff       	call   80102360 <kalloc>
    if(mem == 0){
80106bcb:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
80106bcd:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80106bcf:	75 af                	jne    80106b80 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106bd1:	c7 04 24 3f 78 10 80 	movl   $0x8010783f,(%esp)
80106bd8:	e8 93 9c ff ff       	call   80100870 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106bdd:	8b 45 0c             	mov    0xc(%ebp),%eax
80106be0:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106be4:	89 44 24 08          	mov    %eax,0x8(%esp)
80106be8:	8b 45 08             	mov    0x8(%ebp),%eax
80106beb:	89 04 24             	mov    %eax,(%esp)
80106bee:	e8 5d fd ff ff       	call   80106950 <deallocuvm>
80106bf3:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
      kfree(mem);
      return 0;
    }
  }
...
80106bfd:	83 c4 2c             	add    $0x2c,%esp
80106c00:	5b                   	pop    %ebx
80106c01:	5e                   	pop    %esi
80106c02:	5f                   	pop    %edi
80106c03:	5d                   	pop    %ebp
...
80106c18:	c7 04 24 57 78 10 80 	movl   $0x80107857,(%esp)
80106c1f:	e8 4c 9c ff ff       	call   80100870 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106c24:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c27:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106c2b:	89 44 24 08          	mov    %eax,0x8(%esp)
80106c2f:	8b 45 08             	mov    0x8(%ebp),%eax
80106c32:	89 04 24             	mov    %eax,(%esp)
80106c35:	e8 16 fd ff ff       	call   80106950 <deallocuvm>
      kfree(mem);
80106c3a:	89 1c 24             	mov    %ebx,(%esp)
80106c3d:	e8 6e b7 ff ff       	call   801023b0 <kfree>
80106c42:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
      return 0;
    }
  }
  return newsz;
...
80106c4c:	83 c4 2c             	add    $0x2c,%esp
80106c4f:	5b                   	pop    %ebx
80106c50:	5e                   	pop    %esi
80106c51:	5f                   	pop    %edi
80106c52:	5d                   	pop    %ebp
...
80106c6c:	f7 c7 ff 0f 00 00    	test   $0xfff,%edi
80106c72:	0f 85 96 00 00 00    	jne    80106d0e <loaduvm+0xae>
    panic("loaduvm: addr must be page aligned");
80106c78:	8b 75 18             	mov    0x18(%ebp),%esi
80106c7b:	31 db                	xor    %ebx,%ebx
  for(i = 0; i < sz; i += PGSIZE){
80106c7d:	85 f6                	test   %esi,%esi
80106c7f:	75 18                	jne    80106c99 <loaduvm+0x39>
80106c81:	eb 75                	jmp    80106cf8 <loaduvm+0x98>
80106c83:	90                   	nop
...
80106c9e:	8d 14 1f             	lea    (%edi,%ebx,1),%edx
80106ca1:	e8 7a f9 ff ff       	call   80106620 <walkpgdir>
80106ca6:	85 c0                	test   %eax,%eax
80106ca8:	74 58                	je     80106d02 <loaduvm+0xa2>
      panic("loaduvm: address should exist");
    pa = PTE_ADDR(*pte);
80106caa:	8b 00                	mov    (%eax),%eax
    if(sz - i < PGSIZE)
80106cac:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
80106cb2:	ba 00 10 00 00       	mov    $0x1000,%edx
80106cb7:	0f 42 d6             	cmovb  %esi,%edx
      n = sz - i;
    else
      n = PGSIZE;
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106cba:	8b 4d 14             	mov    0x14(%ebp),%ecx
80106cbd:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106cc1:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106cc4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106cc9:	2d 00 00 00 80       	sub    $0x80000000,%eax
80106cce:	89 44 24 04          	mov    %eax,0x4(%esp)
80106cd2:	8b 45 10             	mov    0x10(%ebp),%eax
80106cd5:	8d 0c 0b             	lea    (%ebx,%ecx,1),%ecx
80106cd8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106cdc:	89 04 24             	mov    %eax,(%esp)
80106cdf:	e8 8c ab ff ff       	call   80101870 <readi>
80106ce4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106ce7:	39 d0                	cmp    %edx,%eax
80106ce9:	74 9d                	je     80106c88 <loaduvm+0x28>
      return -1;
  }
  return 0;
}
...
80106cf6:	5d                   	pop    %ebp
80106cf7:	c3                   	ret    
80106cf8:	83 c4 2c             	add    $0x2c,%esp
  uint i, pa, n;
  pte_t *pte;
...
80106d01:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106d02:	c7 04 24 73 78 10 80 	movl   $0x80107873,(%esp)
80106d09:	e8 c2 96 ff ff       	call   801003d0 <panic>
{
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
80106d0e:	c7 04 24 d0 78 10 80 	movl   $0x801078d0,(%esp)
80106d15:	e8 b6 96 ff ff       	call   801003d0 <panic>
...
80106d24:	83 ec 14             	sub    $0x14,%esp
80106d27:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(p == 0)
80106d2a:	85 db                	test   %ebx,%ebx
80106d2c:	0f 84 aa 00 00 00    	je     80106ddc <switchuvm+0xbc>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106d32:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106d35:	85 c9                	test   %ecx,%ecx
80106d37:	0f 84 b7 00 00 00    	je     80106df4 <switchuvm+0xd4>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106d3d:	8b 53 04             	mov    0x4(%ebx),%edx
80106d40:	85 d2                	test   %edx,%edx
80106d42:	0f 84 a0 00 00 00    	je     80106de8 <switchuvm+0xc8>
    panic("switchuvm: no pgdir");

  pushcli();
80106d48:	e8 b3 d5 ff ff       	call   80104300 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106d4d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106d53:	8d 50 08             	lea    0x8(%eax),%edx
80106d56:	89 d1                	mov    %edx,%ecx
80106d58:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
80106d5f:	c1 e9 10             	shr    $0x10,%ecx
80106d62:	c1 ea 18             	shr    $0x18,%edx
80106d65:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80106d6b:	c6 80 a5 00 00 00 99 	movb   $0x99,0xa5(%eax)
80106d72:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80106d79:	67 00 
80106d7b:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
80106d82:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80106d88:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106d8e:	80 a0 a5 00 00 00 ef 	andb   $0xef,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80106d95:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106d9b:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106da1:	8b 53 08             	mov    0x8(%ebx),%edx
80106da4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106daa:	81 c2 00 10 00 00    	add    $0x1000,%edx
80106db0:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
80106db3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106db9:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
}
...
80106dbf:	b8 30 00 00 00       	mov    $0x30,%eax
80106dc4:	0f 00 d8             	ltr    %ax
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106dc7:	8b 43 04             	mov    0x4(%ebx),%eax
80106dca:	2d 00 00 00 80       	sub    $0x80000000,%eax
80106dcf:	0f 22 d8             	mov    %eax,%cr3
  ltr(SEG_TSS << 3);
...
80106dd6:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106dd7:	e9 64 d5 ff ff       	jmp    80104340 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106ddc:	c7 04 24 91 78 10 80 	movl   $0x80107891,(%esp)
80106de3:	e8 e8 95 ff ff       	call   801003d0 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
80106de8:	c7 04 24 bc 78 10 80 	movl   $0x801078bc,(%esp)
80106def:	e8 dc 95 ff ff       	call   801003d0 <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80106df4:	c7 04 24 a7 78 10 80 	movl   $0x801078a7,(%esp)
80106dfb:	e8 d0 95 ff ff       	call   801003d0 <panic>
...
80106e03:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpunum()];
80106e06:	e8 15 bc ff ff       	call   80102a20 <cpunum>
80106e0b:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80106e11:	05 a0 27 11 80       	add    $0x801127a0,%eax
...
80106e16:	8d 90 b4 00 00 00    	lea    0xb4(%eax),%edx
80106e1c:	66 89 90 8a 00 00 00 	mov    %dx,0x8a(%eax)
80106e23:	89 d1                	mov    %edx,%ecx
80106e25:	c1 ea 18             	shr    $0x18,%edx
80106e28:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)
80106e2e:	c1 e9 10             	shr    $0x10,%ecx

  lgdt(c->gdt, sizeof(c->gdt));
80106e31:	8d 50 70             	lea    0x70(%eax),%edx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
...
80106e34:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80106e3a:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80106e40:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80106e44:	c6 40 7d 9a          	movb   $0x9a,0x7d(%eax)
80106e48:	c6 40 7e cf          	movb   $0xcf,0x7e(%eax)
80106e4c:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106e50:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80106e57:	ff ff 
80106e59:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80106e60:	00 00 
80106e62:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80106e69:	c6 80 85 00 00 00 92 	movb   $0x92,0x85(%eax)
80106e70:	c6 80 86 00 00 00 cf 	movb   $0xcf,0x86(%eax)
80106e77:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106e7e:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80106e85:	ff ff 
80106e87:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80106e8e:	00 00 
80106e90:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80106e97:	c6 80 95 00 00 00 fa 	movb   $0xfa,0x95(%eax)
80106e9e:	c6 80 96 00 00 00 cf 	movb   $0xcf,0x96(%eax)
80106ea5:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106eac:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80106eb3:	ff ff 
80106eb5:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80106ebc:	00 00 
80106ebe:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80106ec5:	c6 80 9d 00 00 00 f2 	movb   $0xf2,0x9d(%eax)
80106ecc:	c6 80 9e 00 00 00 cf 	movb   $0xcf,0x9e(%eax)
80106ed3:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80106eda:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80106ee1:	00 00 
80106ee3:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80106ee9:	c6 80 8d 00 00 00 92 	movb   $0x92,0x8d(%eax)
80106ef0:	c6 80 8e 00 00 00 c0 	movb   $0xc0,0x8e(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80106ef7:	66 c7 45 f2 37 00    	movw   $0x37,-0xe(%ebp)
  pd[1] = (uint)p;
80106efd:	66 89 55 f4          	mov    %dx,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106f01:	c1 ea 10             	shr    $0x10,%edx
80106f04:	66 89 55 f6          	mov    %dx,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106f08:	8d 55 f2             	lea    -0xe(%ebp),%edx
80106f0b:	0f 01 12             	lgdtl  (%edx)
}
...
80106f0e:	ba 18 00 00 00       	mov    $0x18,%edx
80106f13:	8e ea                	mov    %edx,%gs
  ...
  cpu = c;
80106f15:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80106f1b:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80106f22:	00 00 00 00 
}
80106f26:	c9                   	leave  
80106f27:	c3                   	ret    
